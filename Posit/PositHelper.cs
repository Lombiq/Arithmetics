...
namespace Lombiq.Arithmetics
{
    ...
    internal static class PositHelper
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong SetOne(ulong bits, ushort index) => (bits | ((ulong)1 << index));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong SetZero(ulong bits, ushort index) => bits & ~((ulong)1 << index);
