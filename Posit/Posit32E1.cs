...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E1>, IComparable<Posit32E1>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit32E1((uint)value).PositBits : GetTwosComplement(new Posit32E1((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit32E1((ulong)value).PositBits : GetTwosComplement(new Posit32E1((ulong)-value).PositBits);
        }
