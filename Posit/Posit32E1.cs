...
{
    public readonly struct Posit32E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E1>, IComparable<Posit32E1>
    {
        ...
        public Posit32E1(uint bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit32E1(bits).PositBits;

        public Posit32E1(Quire q)
        {
        ...
        public Posit32E1(int value) =>
            PositBits = value >= 0
                ? new Posit32E1((uint)value).PositBits
                : GetTwosComplement(new Posit32E1((uint)-value).PositBits);

        public Posit32E1(ulong value)
        {
            if (value == 0)
            {
                PositBits = (uint)value;
        ...
        public Posit32E1(long value) =>
            PositBits = value >= 0
                ? new Posit32E1((ulong)value).PositBits
                : GetTwosComplement(new Posit32E1((ulong)-value).PositBits);

        public Posit32E1(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit32E1(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit32E1(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public static Quire MultiplyIntoQuire(Posit32E1 left, Posit32E1 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit32E1 Abs(Posit32E1 input)
        {
            var signBit = input.PositBits >> (Size - 1);
            var maskOfSignBits = 0 - signBit;

            return new Posit32E1((uint)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
        ...
        public static Posit32E1 Sqrt(Posit32E1 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit32E1(NaNBitMask, fromBitMask: true);
        ...
        public static Posit32E1 FusedSum(Posit32E1[] posits)
        {
            ...
            return new Posit32E1(resultQuire);
        }

        public static Quire FusedSum(Posit32E1[] posits, Quire startingValue)
        {
        ...
        public static Posit32E1 FusedDotProduct(Posit32E1[] positArray1, Posit32E1[] positArray2)
        {
            if (positArray1.Length != positArray2.Length)
            {
                return new Posit32E1(NaNBitMask, fromBitMask: true);
            }
        ...
        public static Posit32E1 FusedMultiplyAdd(Posit32E1 a, Posit32E1 b, Posit32E1 c)
        {
            var positArray1 = new Posit32E1[2];
            var positArray2 = new Posit32E1[2];

            positArray1[0] = a;
            positArray1[1] = new Posit32E1(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit32E1 FusedAddMultiply(Posit32E1 a, Posit32E1 b, Posit32E1 c)
        {
            var positArray1 = new Posit32E1[2];
            var positArray2 = new Posit32E1[2];
        ...
        public static Posit32E1 FusedMultiplyMultiplySubtract(Posit32E1 a, Posit32E1 b, Posit32E1 c, Posit32E1 d)
        {
            var positArray1 = new Posit32E1[2];
            var positArray2 = new Posit32E1[2];
        ...
        public static Posit32E1 operator +(Posit32E1 left, Posit32E1 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E1(
            ...
            var rightAbsoluteValue = new Posit32E1(
            ...
            {
                return new Posit32E1(0, fromBitMask: true);
            }
        ...
        public static Posit32E1 operator +(Posit32E1 left, int right) => left + new Posit32E1(right);

        public static Posit32E1 operator -(Posit32E1 left, Posit32E1 right) => left + -right;

        public static Posit32E1 operator -(Posit32E1 left, int right) => left - new Posit32E1(right);

        public static Posit32E1 operator -(Posit32E1 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit32E1(x.PositBits, fromBitMask: true)
                : new Posit32E1(GetTwosComplement(x.PositBits), fromBitMask: true);

        public static bool operator ==(Posit32E1 left, Posit32E1 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit32E1 left, Posit32E1 right)
        {
        ...
        public static bool operator !=(Posit32E1 left, Posit32E1 right) => !(left == right);

        public static Posit32E1 operator *(Posit32E1 left, int right) => left * new Posit32E1(right);

        public static Posit32E1 operator *(Posit32E1 left, Posit32E1 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit32E1(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
        ...
        public static Posit32E1 operator /(Posit32E1 left, Posit32E1 right)
        {
            if (right.IsZero()) return new Posit32E1(NaNBitMask, fromBitMask: true);
            if (left.IsZero()) return new Posit32E1(0);
        ...
        public static explicit operator int(Posit32E1 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit32E1 x)
        {
        ...
        public static explicit operator double(Posit32E1 x)
        {
        ...
        public static explicit operator Quire(Posit32E1 x)
        {
        ...
        public static explicit operator Posit8E0(Posit32E1 x)
        {
        ...
        public static explicit operator Posit8E1(Posit32E1 x)
        {
        ...
        public static explicit operator Posit8E2(Posit32E1 x)
        {
        ...
        public static explicit operator Posit8E3(Posit32E1 x)
        {
        ...
        public static explicit operator Posit8E4(Posit32E1 x)
        {
        ...
        public static explicit operator Posit16E0(Posit32E1 x)
        {
        ...
        public static explicit operator Posit16E1(Posit32E1 x)
        {
        ...
        public static explicit operator Posit16E2(Posit32E1 x)
        {
        ...
        public static explicit operator Posit16E3(Posit32E1 x)
        {
        ...
        public static explicit operator Posit16E4(Posit32E1 x)
        {
        ...
        public static explicit operator Posit32E0(Posit32E1 x)
        {
        ...
        public static explicit operator Posit32E2(Posit32E1 x)
        {
        ...
        public static explicit operator Posit32E3(Posit32E1 x)
        {
        ...
        public static explicit operator Posit32E4(Posit32E1 x)
        {
        ...
        {
            null => 1,
            Posit32E1 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit32E1 obj)
        {
        ...
        public Posit32E1 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit32E1 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));

        public bool TryParse(string number, out Posit32E1 positResult)
        {
            var returnValue = double.TryParse(number, out double result);
            positResult = new Posit32E1(result);
            return returnValue;
        }

        public bool Equals(Posit32E1 other) => this == other;

        public override bool Equals(object obj) => obj is Posit32E1 posit && Equals(posit);
