...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit16_2 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_2>, IComparable<Posit16_2>
	{
		...
		public static Posit16_2 Sqrt(Posit16_2 number)
		{
			...
			return new Posit16_2(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_2 operator +(Posit16_2 left, Posit16_2 right)
		{
			...
			return new Posit16_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
