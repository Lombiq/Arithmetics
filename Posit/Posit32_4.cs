...
{
	public readonly struct Posit32_4 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_4>, IComparable<Posit32_4>
	{
		...
		public Posit32_4(uint bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit32_4(bits).PositBits;

		public Posit32_4(Quire q)
		{
		...
		public  Posit32_4(int value)
		{
			PositBits = value >= 0 ? new Posit32_4((uint)value).PositBits : GetTwosComplement(new Posit32_4((uint)-value).PositBits);
		}

		public Posit32_4(ulong value)
		{
		...
		public  Posit32_4(long value)
		{
			PositBits = value >= 0 ? new Posit32_4((ulong)value).PositBits : GetTwosComplement(new Posit32_4((ulong)-value).PositBits);
		}

		public  Posit32_4(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit32_4(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit32_4(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit32_4 left, Posit32_4 right)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit32_4 Abs(Posit32_4 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit32_4((uint)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit32_4 Sqrt(Posit32_4 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit32_4(NaNBitMask, true);
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit32_4(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (uint) resultExponentBits,  resultFractionBits), true);
		}
		...
		public static Posit32_4 FusedSum(Posit32_4[] posits)
		{
		...
		public static Quire FusedSum(Posit32_4[] posits, Quire startingValue)
		{
		...
		public static Posit32_4 FusedDotProduct(Posit32_4[] positArray1, Posit32_4[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit32_4(NaNBitMask, true);
		...
		public static Posit32_4 FusedMultiplyAdd(Posit32_4 a, Posit32_4 b, Posit32_4 c)
		{
			var positArray1 = new Posit32_4[2];
			var positArray2 = new Posit32_4[2];

			positArray1[0] = a;
			positArray1[1] = new Posit32_4(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit32_4 FusedAddMultiply(Posit32_4 a, Posit32_4 b, Posit32_4 c)
		{
			var positArray1 = new Posit32_4[2];
			var positArray2 = new Posit32_4[2];
		...
		public static Posit32_4 FusedMultiplyMultiplySubtract(Posit32_4 a, Posit32_4 b, Posit32_4 c, Posit32_4 d)
		{
			var positArray1 = new Posit32_4[2];
			var positArray2 = new Posit32_4[2];
		...
		public static Posit32_4 operator +(Posit32_4 left, Posit32_4 right)
		{
			...
			var leftAbsoluteValue = new Posit32_4((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit32_4((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (resultFractionBits == 0) return new Posit32_4(0, true);
			...
			return new Posit32_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, (ulong)resultFractionBits), true);
		}

		public static Posit32_4 operator +(Posit32_4 left, int right) => left + new Posit32_4(right);

		public static Posit32_4 operator -(Posit32_4 left, Posit32_4 right) => left + -right;

		public static Posit32_4 operator -(Posit32_4 left, int right) => left - new Posit32_4(right);

		public static Posit32_4 operator -(Posit32_4 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit32_4(x.PositBits, true);
			return new Posit32_4(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit32_4 left, Posit32_4 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit32_4 left, Posit32_4 right)
		{
		...
		public static bool operator !=(Posit32_4 left, Posit32_4 right) => !(left == right);

		public static Posit32_4 operator *(Posit32_4 left, int right) => left * new Posit32_4(right);

		public static Posit32_4 operator *(Posit32_4 left, Posit32_4 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit32_4(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			return new Posit32_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, longResultFractionBits), true);
		}
		...
		public static Posit32_4 operator /(Posit32_4 left, Posit32_4 right)
		{
			if (left.IsZero()) return new Posit32_4(0);
			if (right.IsZero()) return new Posit32_4(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static explicit operator int(Posit32_4 x)
		{
			uint result;
		...
		public static explicit operator float(Posit32_4 x)
		{
		...
		public static explicit operator double(Posit32_4 x)
		{
		...
		public static explicit operator Posit8_0(Posit32_4 x)
		{
			...
			public static explicit operator Posit8_1(Posit32_4 x)
		{
			...
			public static explicit operator Posit8_2(Posit32_4 x)
		{
			...
			public static explicit operator Posit8_3(Posit32_4 x)
		{
			...
			public static explicit operator Posit8_4(Posit32_4 x)
		{
			...
			public static explicit operator Posit16_0(Posit32_4 x)
		{
			...
			public static explicit operator Posit16_1(Posit32_4 x)
		{
			...
			public static explicit operator Posit16_2(Posit32_4 x)
		{
			...
			public static explicit operator Posit16_3(Posit32_4 x)
		{
			...
			public static explicit operator Posit16_4(Posit32_4 x)
		{
			...
			public static explicit operator Posit32_0(Posit32_4 x)
		{
			...
			public static explicit operator Posit32_1(Posit32_4 x)
		{
			...
			public static explicit operator Posit32_2(Posit32_4 x)
		{
			...
			public static explicit operator Posit32_3(Posit32_4 x)
		{
		...
		public Posit32_4  Parse(string number) => new Posit32_4(Double.Parse(number));

		public bool TryParse(string number, out Posit32_4  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit32_4 (result);
			return returnValue;
		}

		public bool Equals(Posit32_4  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit32_4  posit) ? Equals(posit) : false;
