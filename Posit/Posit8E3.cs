...
{
    public readonly struct Posit8E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E3>, IComparable<Posit8E3>
    {
        ...
        public const byte FirstRegimeBitBitMask = 1 << (Size - 2);
        ...
        public Posit8E3(byte bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit8E3(bits).PositBits;

        public Posit8E3(Quire q)
        {
            ...
            PositBits = AssemblePositBitsWithRounding(
                ...
                resultRegimeKValue,
                resultExponentBits,
                (byte)(q >> (QuireSize - Size)));
        }

        public Posit8E3(uint value)
        {
            if (value == 0)
            {
        ...
        public Posit8E3(int value) =>
            PositBits = value >= 0
                ? new Posit8E3((uint)value).PositBits
                : GetTwosComplement(new Posit8E3((uint)-value).PositBits);

        public Posit8E3(ulong value)
        {
            if (value == 0)
            {
                PositBits = (byte)value;
        ...
        public Posit8E3(long value) =>
            PositBits = value >= 0
                ? new Posit8E3((ulong)value).PositBits
                : GetTwosComplement(new Posit8E3((ulong)-value).PositBits);

        public Posit8E3(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E3(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E3(bool sign, short scaleFactor, byte fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public Posit8E3(bool sign, short scaleFactor, ushort fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public Posit8E3(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public static byte EncodeRegimeBits(int regimeKValue)
        {
            ...
            {
                regimeBits = (byte)(FirstRegimeBitBitMask >> -regimeKValue);
            }
            ...
            byte fractionBits)
        {
            ...
            wholePosit += exponentShiftedLeftBy >= 0
                ? (byte)(exponentBits << exponentShiftedLeftBy)
                : (byte)(exponentBits >> -exponentShiftedLeftBy);
            ...
            wholePosit += fractionShiftedLeftBy >= 0
                ? (byte)(fractionBits << fractionShiftedLeftBy)
                : (byte)(fractionBits >> -fractionShiftedLeftBy);
        ...
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,ushort exponentBits ,  ushort fractionBits)
        {
            ...
            fractionBits = PositHelper.SetZero(fractionBits, (ushort)fractionMostSignificantOneIndex);
                                ...
                                if (exponentShiftedLeftBy < 0) //The exponent is shifted to the right, so no fraction bits will fit in the number
                                {
                                    ...
                                    if ((byte) exponentBits < SignBitMask) return signBit ? GetTwosComplement(wholePosit) : wholePosit; //The first non-fitting exponent bit is zero, so we dont round up.

                                    if (((byte)exponentBits == SignBitMask) && (fractionBits==0)) wholePosit += (byte)(wholePosit & 1); 
        ...
        //This method is necessary for conversions from posits wiht bigger underlying structures. 
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,ulong exponentBits ,  ulong fractionBits)
        {
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Quire MultiplyIntoQuire(Posit8E3 left, Posit8E3 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit8E3 Abs(Posit8E3 input)
        {
            var signBit = input.PositBits >> Size - 1;
            var maskOfSignBits = 0 - signBit;
            return new Posit8E3((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit8E3 Sqrt(Posit8E3 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit8E3(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit8E3(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (byte) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit8E3 FusedSum(Posit8E3[] posits)
        {
            ...
            return new Posit8E3(resultQuire);
        }

        public static Quire FusedSum(Posit8E3[] posits, Quire startingValue)
        {
        ...
        public static Posit8E3 FusedDotProduct(Posit8E3[] positArray1, Posit8E3[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit8E3(NaNBitMask, true);
        ...
        public static Posit8E3 FusedMultiplyAdd(Posit8E3 a, Posit8E3 b, Posit8E3 c)
        {
            var positArray1 = new Posit8E3[2];
            var positArray2 = new Posit8E3[2];

            positArray1[0] = a;
            positArray1[1] = new Posit8E3(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit8E3 FusedAddMultiply(Posit8E3 a, Posit8E3 b, Posit8E3 c)
        {
            var positArray1 = new Posit8E3[2];
            var positArray2 = new Posit8E3[2];
        ...
        public static Posit8E3 FusedMultiplyMultiplySubtract(Posit8E3 a, Posit8E3 b, Posit8E3 c, Posit8E3 d)
        {
            var positArray1 = new Posit8E3[2];
            var positArray2 = new Posit8E3[2];
        ...
        public static Posit8E3 operator +(Posit8E3 left, Posit8E3 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E3((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit8E3((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit8E3(0, true);
            ...
            return new Posit8E3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
        }

        public static Posit8E3 operator +(Posit8E3 left, int right) => left + new Posit8E3(right);

        public static Posit8E3 operator -(Posit8E3 left, Posit8E3 right) => left + -right;

        public static Posit8E3 operator -(Posit8E3 left, int right) => left - new Posit8E3(right);

        public static Posit8E3 operator -(Posit8E3 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit8E3(x.PositBits, true);
            return new Posit8E3(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit8E3 left, Posit8E3 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit8E3 left, Posit8E3 right)
        {
        ...
        public static bool operator !=(Posit8E3 left, Posit8E3 right) => !(left == right);

        public static Posit8E3 operator *(Posit8E3 left, int right) => left * new Posit8E3(right);

        public static Posit8E3 operator *(Posit8E3 left, Posit8E3 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit8E3(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit8E3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit8E3 operator /(Posit8E3 left, Posit8E3 right)
        {
            if (right.IsZero()) return new Posit8E3(NaNBitMask, true);
            if (left.IsZero()) return new Posit8E3(0);
        ...
        public static explicit operator int(Posit8E3 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit8E3 x)
        {
        ...
        public static explicit operator double(Posit8E3 x)
        {
        ...
        public static explicit operator Quire(Posit8E3 x)
        {
        ...
        public static explicit operator Posit8E0(Posit8E3 x)
        {
            ...
            public static explicit operator Posit8E1(Posit8E3 x)
        {
            ...
            public static explicit operator Posit8E2(Posit8E3 x)
        {
            ...
            public static explicit operator Posit8E4(Posit8E3 x)
        {
            ...
            public static explicit operator Posit16E0(Posit8E3 x)
        {
            ...
            public static explicit operator Posit16E1(Posit8E3 x)
        {
            ...
            public static explicit operator Posit16E2(Posit8E3 x)
        {
            ...
            public static explicit operator Posit16E3(Posit8E3 x)
        {
            ...
            public static explicit operator Posit16E4(Posit8E3 x)
        {
            ...
            public static explicit operator Posit32E0(Posit8E3 x)
        {
            ...
            public static explicit operator Posit32E1(Posit8E3 x)
        {
            ...
            public static explicit operator Posit32E2(Posit8E3 x)
        {
            ...
            public static explicit operator Posit32E3(Posit8E3 x)
        {
            ...
            public static explicit operator Posit32E4(Posit8E3 x)
        {
        ...
        public int CompareTo(Posit8E3  value)
        {
        ...
        public Posit8E3  Parse(string number) => new Posit8E3(Double.Parse(number));

        public bool TryParse(string number, out Posit8E3  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit8E3 (result);
            return returnValue;
        }

        public bool Equals(Posit8E3  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit8E3  posit) ? Equals(posit) : false;
