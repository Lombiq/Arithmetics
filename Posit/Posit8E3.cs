...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E3>, IComparable<Posit8E3>
    {
        ...
        public static Posit8E3 operator +(Posit8E3 left, Posit8E3 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E3(
            ...
            var rightAbsoluteValue = new Posit8E3(
            ...
            {
                return new Posit8E3(0, fromBitMask: true);
            }
        ...
        public static Posit8E3 operator -(Posit8E3 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit8E3(x.PositBits, fromBitMask: true)
                : new Posit8E3(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit8E3 operator /(Posit8E3 left, Posit8E3 right)
        {
            if (right.IsZero()) return new Posit8E3(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit8E3 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit8E3 obj)
        {
        ...
        public Posit8E3 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit8E3 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit8E3 posit && Equals(posit);
