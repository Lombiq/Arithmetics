...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E3>, IComparable<Posit8E3>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit8E3((uint)value).PositBits : GetTwosComplement(new Posit8E3((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit8E3((ulong)value).PositBits : GetTwosComplement(new Posit8E3((ulong)-value).PositBits);
        }
