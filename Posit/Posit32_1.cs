...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit32_1 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_1>, IComparable<Posit32_1>
	{
		...
		public static Posit32_1 Sqrt(Posit32_1 number)
		{
			...
			return new Posit32_1(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit32_1 operator +(Posit32_1 left, Posit32_1 right)
		{
			...
			return new Posit32_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
