...
{
	public readonly struct Posit32_1 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_1>, IComparable<Posit32_1>
	{
		...
		public Posit32_1(uint bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit32_1(bits).PositBits;

		public Posit32_1(Quire q)
		{
		...
		public  Posit32_1(int value)
		{
			PositBits = value >= 0 ? new Posit32_1((uint)value).PositBits : GetTwosComplement(new Posit32_1((uint)-value).PositBits);
		}

		public Posit32_1(ulong value)
		{
		...
		public  Posit32_1(long value)
		{
			PositBits = value >= 0 ? new Posit32_1((ulong)value).PositBits : GetTwosComplement(new Posit32_1((ulong)-value).PositBits);
		}

		public  Posit32_1(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit32_1(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit32_1(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			...
			fractionBits = PositHelper.SetZero(fractionBits, (ushort)fractionMostSignificantOneIndex);
						...
						if (exponentShiftedLeftBy < 0) //Our only exponent bit is lost.
						{
							...
							if (exponentBits == 1)
							{
								...
								{
									wholePosit += 1;
								}else wholePosit +=  (uint)(wholePosit & 1);
							}else  return signBit ? GetTwosComplement(wholePosit) : wholePosit;      
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit32_1 left, Posit32_1 right)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit32_1 Abs(Posit32_1 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit32_1((uint)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit32_1 Sqrt(Posit32_1 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit32_1(NaNBitMask, true);
			...
			ulong estimateMaskingBit = (SignBitMask << (Size - 2)); 
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit32_1(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (uint) resultExponentBits,  resultFractionBits), true);
		}
		...
		public static Posit32_1 FusedSum(Posit32_1[] posits)
		{
			...
			return new Posit32_1(resultQuire);
		}

		public static Quire FusedSum(Posit32_1[] posits, Quire startingValue)
		{
		...
		public static Posit32_1 FusedDotProduct(Posit32_1[] positArray1, Posit32_1[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit32_1(NaNBitMask, true);
		...
		public static Posit32_1 FusedMultiplyAdd(Posit32_1 a, Posit32_1 b, Posit32_1 c)
		{
			var positArray1 = new Posit32_1[2];
			var positArray2 = new Posit32_1[2];

			positArray1[0] = a;
			positArray1[1] = new Posit32_1(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit32_1 FusedAddMultiply(Posit32_1 a, Posit32_1 b, Posit32_1 c)
		{
			var positArray1 = new Posit32_1[2];
			var positArray2 = new Posit32_1[2];
		...
		public static Posit32_1 FusedMultiplyMultiplySubtract(Posit32_1 a, Posit32_1 b, Posit32_1 c, Posit32_1 d)
		{
			var positArray1 = new Posit32_1[2];
			var positArray2 = new Posit32_1[2];
		...
		public static Posit32_1 operator +(Posit32_1 left, Posit32_1 right)
		{
			...
			var leftAbsoluteValue = new Posit32_1((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit32_1((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (scaleFactorDifference == 0)
			{
				if (signBitsMatch)
				{
					resultFractionBits += (ulong)(leftFraction + rightFraction);
				}
				else
				{
					...
					{
						resultFractionBits +=(ulong) (rightFraction - leftFraction);
					}
				}
			...
			else if (scaleFactorDifference > 0) // The scale factor of the left Posit is bigger.
			{
				...
				if (signBitsMatch)
				{
					...
					{
						resultFractionBits +=(ulong)(rightFraction << smallerPositMovedToLeft);
					}
					else resultFractionBits +=(ulong) (rightFraction >> -smallerPositMovedToLeft);
				}
				else resultFractionBits -= smallerPositMovedToLeft >= 0
						? (ulong)(rightFraction << smallerPositMovedToLeft)
						: (ulong)(rightFraction >> -smallerPositMovedToLeft);
			...
			else // The scale factor of the right Posit is bigger.
			{
				...
				if (signBitsMatch)
				{
					...
					{
						resultFractionBits += (ulong)(leftFraction << (biggerPositMovedToLeft + scaleFactorDifference + fractionSizeDifference));
					}
					else resultFractionBits += (ulong)(leftFraction >> -(biggerPositMovedToLeft + scaleFactorDifference + fractionSizeDifference));
			...
			if (resultFractionBits == 0) return new Posit32_1(0, true);
			...
			return new Posit32_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, (ulong)resultFractionBits), true);
		}

		public static Posit32_1 operator +(Posit32_1 left, int right) => left + new Posit32_1(right);

		public static Posit32_1 operator -(Posit32_1 left, Posit32_1 right) => left + -right;

		public static Posit32_1 operator -(Posit32_1 left, int right) => left - new Posit32_1(right);

		public static Posit32_1 operator -(Posit32_1 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit32_1(x.PositBits, true);
			return new Posit32_1(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit32_1 left, Posit32_1 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit32_1 left, Posit32_1 right)
		{
		...
		public static bool operator !=(Posit32_1 left, Posit32_1 right) => !(left == right);

		public static Posit32_1 operator *(Posit32_1 left, int right) => left * new Posit32_1(right);

		public static Posit32_1 operator *(Posit32_1 left, Posit32_1 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit32_1(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			ulong longResultFractionBits = (ulong)(left.FractionWithHiddenBitWithoutSignCheck() *
			...
			return new Posit32_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, longResultFractionBits), true);
		}
		...
		public static Posit32_1 operator /(Posit32_1 left, Posit32_1 right)
		{
			if (left.IsZero()) return new Posit32_1(0);
			if (right.IsZero()) return new Posit32_1(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			var alignedLeftFraction = (ulong)(left.FractionWithHiddenBitWithoutSignCheck() << (int)(2*Size - 1 - leftFractionSize));
		...
		public static explicit operator int(Posit32_1 x)
		{
			uint result;
		...
		public static explicit operator float(Posit32_1 x)
		{
		...
		public static explicit operator double(Posit32_1 x)
		{
		...
		public static explicit operator Quire(Posit32_1 x)
		{
		...
		public static explicit operator Posit8_0(Posit32_1 x)
		{
			...
			public static explicit operator Posit8_1(Posit32_1 x)
		{
			...
			public static explicit operator Posit8_2(Posit32_1 x)
		{
			...
			public static explicit operator Posit8_3(Posit32_1 x)
		{
			...
			public static explicit operator Posit8_4(Posit32_1 x)
		{
			...
			public static explicit operator Posit16_0(Posit32_1 x)
		{
			...
			public static explicit operator Posit16_1(Posit32_1 x)
		{
			...
			public static explicit operator Posit16_2(Posit32_1 x)
		{
			...
			public static explicit operator Posit16_3(Posit32_1 x)
		{
			...
			public static explicit operator Posit16_4(Posit32_1 x)
		{
			...
			public static explicit operator Posit32_0(Posit32_1 x)
		{
			...
			public static explicit operator Posit32_2(Posit32_1 x)
		{
			...
			public static explicit operator Posit32_3(Posit32_1 x)
		{
			...
			public static explicit operator Posit32_4(Posit32_1 x)
		{
		...
		public Posit32_1  Parse(string number) => new Posit32_1(Double.Parse(number));

		public bool TryParse(string number, out Posit32_1  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit32_1 (result);
			return returnValue;
		}

		public bool Equals(Posit32_1  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit32_1  posit) ? Equals(posit) : false;
