...
{
    public readonly struct Posit32E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E0>, IComparable<Posit32E0>
    {
        ...
        public Posit32E0(uint bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit32E0(bits).PositBits;

        public Posit32E0(Quire q)
        {
        ...
        public Posit32E0(int value) =>
            PositBits = value >= 0
                ? new Posit32E0((uint)value).PositBits
                : GetTwosComplement(new Posit32E0((uint)-value).PositBits);

        public Posit32E0(ulong value)
        {
            if (value == 0)
            {
                PositBits = (uint)value;
        ...
        public Posit32E0(long value) =>
            PositBits = value >= 0
                ? new Posit32E0((ulong)value).PositBits
                : GetTwosComplement(new Posit32E0((ulong)-value).PositBits);

        public Posit32E0(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit32E0(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public static Quire MultiplyIntoQuire(Posit32E0 left, Posit32E0 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit32E0 Abs(Posit32E0 input)
        {
            var signBit = input.PositBits >> (Size - 1);
            var maskOfSignBits = 0 - signBit;

            return new Posit32E0((uint)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
        ...
        public static Posit32E0 Sqrt(Posit32E0 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit32E0(NaNBitMask, fromBitMask: true);
        ...
        public static Posit32E0 FusedSum(Posit32E0[] posits)
        {
        ...
        public static Quire FusedSum(Posit32E0[] posits, Quire startingValue)
        {
        ...
        public static Posit32E0 FusedMultiplyAdd(Posit32E0 a, Posit32E0 b, Posit32E0 c)
        {
            var positArray1 = new Posit32E0[2];
            var positArray2 = new Posit32E0[2];

            positArray1[0] = a;
            positArray1[1] = new Posit32E0(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit32E0 FusedAddMultiply(Posit32E0 a, Posit32E0 b, Posit32E0 c)
        {
            var positArray1 = new Posit32E0[2];
            var positArray2 = new Posit32E0[2];
        ...
        public static Posit32E0 FusedMultiplyMultiplySubtract(Posit32E0 a, Posit32E0 b, Posit32E0 c, Posit32E0 d)
        {
            var positArray1 = new Posit32E0[2];
            var positArray2 = new Posit32E0[2];
        ...
        public static Posit32E0 operator +(Posit32E0 left, Posit32E0 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E0(
            ...
            var rightAbsoluteValue = new Posit32E0(
            ...
            {
                return new Posit32E0(0, fromBitMask: true);
            }
        ...
        public static Posit32E0 operator +(Posit32E0 left, int right) => left + new Posit32E0(right);

        public static Posit32E0 operator -(Posit32E0 left, Posit32E0 right) => left + -right;

        public static Posit32E0 operator -(Posit32E0 left, int right) => left - new Posit32E0(right);

        public static Posit32E0 operator -(Posit32E0 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit32E0(x.PositBits, fromBitMask: true)
                : new Posit32E0(GetTwosComplement(x.PositBits), fromBitMask: true);

        public static bool operator ==(Posit32E0 left, Posit32E0 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit32E0 left, Posit32E0 right)
        {
        ...
        public static bool operator !=(Posit32E0 left, Posit32E0 right) => !(left == right);

        public static Posit32E0 operator *(Posit32E0 left, int right) => left * new Posit32E0(right);

        public static Posit32E0 operator *(Posit32E0 left, Posit32E0 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit32E0(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
        ...
        public static Posit32E0 operator /(Posit32E0 left, Posit32E0 right)
        {
            if (right.IsZero()) return new Posit32E0(NaNBitMask, fromBitMask: true);
            if (left.IsZero()) return new Posit32E0(0);
        ...
        public static explicit operator int(Posit32E0 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit32E0 x)
        {
        ...
        public static explicit operator double(Posit32E0 x)
        {
        ...
        public static explicit operator Quire(Posit32E0 x)
        {
        ...
        public static explicit operator Posit8E0(Posit32E0 x)
        {
        ...
        public static explicit operator Posit8E1(Posit32E0 x)
        {
        ...
        public static explicit operator Posit8E2(Posit32E0 x)
        {
        ...
        public static explicit operator Posit8E3(Posit32E0 x)
        {
        ...
        public static explicit operator Posit8E4(Posit32E0 x)
        {
        ...
        public static explicit operator Posit16E0(Posit32E0 x)
        {
        ...
        public static explicit operator Posit16E1(Posit32E0 x)
        {
        ...
        public static explicit operator Posit16E2(Posit32E0 x)
        {
        ...
        public static explicit operator Posit16E3(Posit32E0 x)
        {
        ...
        public static explicit operator Posit16E4(Posit32E0 x)
        {
        ...
        public static explicit operator Posit32E1(Posit32E0 x)
        {
        ...
        public static explicit operator Posit32E2(Posit32E0 x)
        {
        ...
        public static explicit operator Posit32E3(Posit32E0 x)
        {
        ...
        public static explicit operator Posit32E4(Posit32E0 x)
        {
        ...
        {
            null => 1,
            Posit32E0 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit32E0 obj)
        {
        ...
        public Posit32E0 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit32E0 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));

        public bool TryParse(string number, out Posit32E0 positResult)
        {
            var returnValue = double.TryParse(number, out double result);
            positResult = new Posit32E0(result);
            return returnValue;
        }

        public bool Equals(Posit32E0 other) => this == other;

        public override bool Equals(object obj) => obj is Posit32E0 posit && Equals(posit);
