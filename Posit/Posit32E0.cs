...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E0>, IComparable<Posit32E0>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit32E0((uint)value).PositBits : GetTwosComplement(new Posit32E0((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit32E0((ulong)value).PositBits : GetTwosComplement(new Posit32E0((ulong)-value).PositBits);
        }
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Posit32E0 Abs(Posit32E0 input)
        {
            ...
            return new Posit32E0((uint)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit32E0 Sqrt(Posit32E0 number)
        {
            ...
            if (!number.IsPositive()) return new Posit32E0(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit32E0(AssemblePositBitsWithRounding(false, resultRegimeKValue,    resultFractionBits), true);
        }
        ...
        public static Posit32E0 operator +(Posit32E0 left, Posit32E0 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E0((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit32E0((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit32E0(0, true);
            ...
            return new Posit32E0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  (ulong)resultFractionBits), true);
        }
        ...
        {
            if (x.IsNaN() || x.IsZero()) return new Posit32E0(x.PositBits, true);
            return new Posit32E0(GetTwosComplement(x.PositBits), true);
        }
        ...
        public static Posit32E0 operator *(Posit32E0 left, Posit32E0 right)
        {
            ...
            return new Posit32E0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  longResultFractionBits), true);
        }
        ...
        public static Posit32E0 operator /(Posit32E0 left, Posit32E0 right)
        {
            if (right.IsZero()) return new Posit32E0(NaNBitMask, true);
