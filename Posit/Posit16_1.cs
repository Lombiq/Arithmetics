...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit16_1 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_1>, IComparable<Posit16_1>
	{
		...
		public Posit16_1(uint value)
		{
			...
			while (value >ushort.MaxValue) value >>= 1;			
	...
	#region Methods to handle parts of the Posit 
		...
		public static Posit16_1 operator +(Posit16_1 left, Posit16_1 right)
		{
			...
			return new Posit16_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_1 operator /(Posit16_1 left, Posit16_1 right)
		{
			...
			var fractionSizeChange = PositHelper.GetMostSignificantOnePosition(longResultFractionBits) - (17);
