...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit16_1 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_1>, IComparable<Posit16_1>
	{
		...
		public static Posit16_1 Sqrt(Posit16_1 number)
		{
			...
			return new Posit16_1(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_1 operator +(Posit16_1 left, Posit16_1 right)
		{
			...
			return new Posit16_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
