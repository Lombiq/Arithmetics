...
{
	public readonly struct Posit8_4 : IComparable, IConvertible, IFormattable, IEquatable<Posit8_4>, IComparable<Posit8_4>
	{
		...
		public Posit8_4(byte bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit8_4(bits).PositBits;

		public Posit8_4(Quire q)
		{
		...
		public Posit8_4(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit8_4(bool sign, short scaleFactor, byte fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			...
			public  Posit8_4(bool sign, short scaleFactor, ushort fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
			if (resultExponentBits < 0)
			...
			public  Posit8_4(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
			if (resultExponentBits < 0)
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit8_4 left, Posit8_4 right)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit8_4 Abs(Posit8_4 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit8_4((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit8_4 Sqrt(Posit8_4 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit8_4(NaNBitMask, true);
		...
		public static Posit8_4 FusedSum(Posit8_4[] posits)
		{
			...
			return new Posit8_4(resultQuire);
		}

		public static Quire FusedSum(Posit8_4[] posits, Quire startingValue)
		{
		...
		public static Posit8_4 FusedDotProduct(Posit8_4[] positArray1, Posit8_4[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit8_4(NaNBitMask, true);
		...
		public static Posit8_4 FusedMultiplyAdd(Posit8_4 a, Posit8_4 b, Posit8_4 c)
		{
			var positArray1 = new Posit8_4[2];
			var positArray2 = new Posit8_4[2];

			positArray1[0] = a;
			positArray1[1] = new Posit8_4(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit8_4 FusedAddMultiply(Posit8_4 a, Posit8_4 b, Posit8_4 c)
		{
			var positArray1 = new Posit8_4[2];
			var positArray2 = new Posit8_4[2];
		...
		public static Posit8_4 FusedMultiplyMultiplySubtract(Posit8_4 a, Posit8_4 b, Posit8_4 c, Posit8_4 d)
		{
			var positArray1 = new Posit8_4[2];
			var positArray2 = new Posit8_4[2];
		...
		public static Posit8_4 operator +(Posit8_4 left, Posit8_4 right)
		{
			...
			var leftAbsoluteValue = new Posit8_4((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit8_4((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (resultFractionBits == 0) return new Posit8_4(0, true);
			...
			return new Posit8_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, resultFractionBits), true);
		}

		public static Posit8_4 operator +(Posit8_4 left, int right) => left + new Posit8_4(right);

		public static Posit8_4 operator -(Posit8_4 left, Posit8_4 right) => left + -right;

		public static Posit8_4 operator -(Posit8_4 left, int right) => left - new Posit8_4(right);

		public static Posit8_4 operator -(Posit8_4 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit8_4(x.PositBits, true);
			return new Posit8_4(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit8_4 left, Posit8_4 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit8_4 left, Posit8_4 right)
		{
		...
		public static bool operator !=(Posit8_4 left, Posit8_4 right) => !(left == right);

		public static Posit8_4 operator *(Posit8_4 left, int right) => left * new Posit8_4(right);

		public static Posit8_4 operator *(Posit8_4 left, Posit8_4 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit8_4(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static Posit8_4 operator /(Posit8_4 left, Posit8_4 right)
		{
			if (left.IsZero()) return new Posit8_4(0);
			if (right.IsZero()) return new Posit8_4(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static explicit operator int(Posit8_4 x)
		{
			uint result;
		...
		public static explicit operator float(Posit8_4 x)
		{
		...
		public static explicit operator double(Posit8_4 x)
		{
		...
		public static explicit operator Quire(Posit8_4 x)
		{
		...
		public static explicit operator Posit8_0(Posit8_4 x)
		{
		...
		public static explicit operator Posit8_1(Posit8_4 x)
		{
		...
		public static explicit operator Posit8_2(Posit8_4 x)
		{
		...
		public static explicit operator Posit8_3(Posit8_4 x)
		{
		...
		public static explicit operator Posit16_0(Posit8_4 x)
		{
		...
		public static explicit operator Posit16_1(Posit8_4 x)
		{
		...
		public static explicit operator Posit16_2(Posit8_4 x)
		{
		...
		public static explicit operator Posit16_3(Posit8_4 x)
		{
		...
		public static explicit operator Posit16_4(Posit8_4 x)
		{
		...
		public static explicit operator Posit32_0(Posit8_4 x)
		{
		...
		public static explicit operator Posit32_1(Posit8_4 x)
		{
		...
		public static explicit operator Posit32_2(Posit8_4 x)
		{
		...
		public static explicit operator Posit32_3(Posit8_4 x)
		{
		...
		public static explicit operator Posit32_4(Posit8_4 x)
		{
		...
		public int CompareTo(Posit8_4  value)
		{
		...
		public Posit8_4  Parse(string number) => new Posit8_4(Double.Parse(number));

		public bool TryParse(string number, out Posit8_4  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit8_4 (result);
			return returnValue;
		}

		public bool Equals(Posit8_4  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit8_4  posit) ? Equals(posit) : false;
