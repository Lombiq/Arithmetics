...
namespace Lombiq.Arithmetics
{
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Posit8_4 operator +(Posit8_4 left, Posit8_4 right)
        {
            ...
            return new Posit8_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
        }
        ...
        public static Posit8_4 operator *(Posit8_4 left, Posit8_4 right)
        {
            ...
            return new Posit8_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
        }
