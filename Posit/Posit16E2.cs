...
{
    public readonly struct Posit16E2 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E2>, IComparable<Posit16E2>
    {
        ...
        public Posit16E2(ushort bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit16E2(bits).PositBits;

        public Posit16E2(Quire q)
        {
        ...
        public  Posit16E2(int value)
        {
            PositBits = value >= 0 ? new Posit16E2((uint)value).PositBits : GetTwosComplement(new Posit16E2((uint)-value).PositBits);
        }

        public Posit16E2(ulong value)
        {
        ...
        public  Posit16E2(long value)
        {
            PositBits = value >= 0 ? new Posit16E2((ulong)value).PositBits : GetTwosComplement(new Posit16E2((ulong)-value).PositBits);
        }

        public  Posit16E2(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit16E2(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        #region Posit constructors for Posit conversions
            ...
            public  Posit16E2(bool sign, short scaleFactor, ushort fraction)
        {
                    var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            ...
            public  Posit16E2(bool sign, short scaleFactor, uint fraction)
        {
                    var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
            if (resultExponentBits < 0)
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Quire MultiplyIntoQuire(Posit16E2 left, Posit16E2 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit16E2 Abs(Posit16E2 input)
        {
            var signBit = input.PositBits >> Size - 1;
            var maskOfSignBits = 0 - signBit;
            return new Posit16E2((ushort)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit16E2 Sqrt(Posit16E2 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit16E2(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit16E2(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (ushort) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit16E2 FusedSum(Posit16E2[] posits)
        {
            ...
            return new Posit16E2(resultQuire);
        }

        public static Quire FusedSum(Posit16E2[] posits, Quire startingValue)
        {
        ...
        public static Posit16E2 FusedDotProduct(Posit16E2[] positArray1, Posit16E2[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit16E2(NaNBitMask, true);
        ...
        public static Posit16E2 FusedMultiplyAdd(Posit16E2 a, Posit16E2 b, Posit16E2 c)
        {
            var positArray1 = new Posit16E2[2];
            var positArray2 = new Posit16E2[2];

            positArray1[0] = a;
            positArray1[1] = new Posit16E2(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit16E2 FusedAddMultiply(Posit16E2 a, Posit16E2 b, Posit16E2 c)
        {
            var positArray1 = new Posit16E2[2];
            var positArray2 = new Posit16E2[2];
        ...
        public static Posit16E2 FusedMultiplyMultiplySubtract(Posit16E2 a, Posit16E2 b, Posit16E2 c, Posit16E2 d)
        {
            var positArray1 = new Posit16E2[2];
            var positArray2 = new Posit16E2[2];
        ...
        public static Posit16E2 operator +(Posit16E2 left, Posit16E2 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E2((ushort)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit16E2((ushort)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit16E2(0, true);
            ...
            return new Posit16E2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, (uint)resultFractionBits), true);
        }

        public static Posit16E2 operator +(Posit16E2 left, int right) => left + new Posit16E2(right);

        public static Posit16E2 operator -(Posit16E2 left, Posit16E2 right) => left + -right;

        public static Posit16E2 operator -(Posit16E2 left, int right) => left - new Posit16E2(right);

        public static Posit16E2 operator -(Posit16E2 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit16E2(x.PositBits, true);
            return new Posit16E2(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit16E2 left, Posit16E2 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit16E2 left, Posit16E2 right)
        {
        ...
        public static bool operator !=(Posit16E2 left, Posit16E2 right) => !(left == right);

        public static Posit16E2 operator *(Posit16E2 left, int right) => left * new Posit16E2(right);

        public static Posit16E2 operator *(Posit16E2 left, Posit16E2 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit16E2(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit16E2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit16E2 operator /(Posit16E2 left, Posit16E2 right)
        {
            if (right.IsZero()) return new Posit16E2(NaNBitMask, true);
            if (left.IsZero()) return new Posit16E2(0);
        ...
        public static explicit operator int(Posit16E2 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit16E2 x)
        {
        ...
        public static explicit operator double(Posit16E2 x)
        {
        ...
        public static explicit operator Quire(Posit16E2 x)
        {
        ...
        public static explicit operator Posit8E0(Posit16E2 x)
        {
            ...
            public static explicit operator Posit8E1(Posit16E2 x)
        {
            ...
            public static explicit operator Posit8E2(Posit16E2 x)
        {
            ...
            public static explicit operator Posit8E3(Posit16E2 x)
        {
            ...
            public static explicit operator Posit8E4(Posit16E2 x)
        {
            ...
            public static explicit operator Posit16E0(Posit16E2 x)
        {
            ...
            public static explicit operator Posit16E1(Posit16E2 x)
        {
            ...
            public static explicit operator Posit16E3(Posit16E2 x)
        {
            ...
            public static explicit operator Posit16E4(Posit16E2 x)
        {
            ...
            public static explicit operator Posit32E0(Posit16E2 x)
        {
            ...
            public static explicit operator Posit32E1(Posit16E2 x)
        {
            ...
            public static explicit operator Posit32E2(Posit16E2 x)
        {
            ...
            public static explicit operator Posit32E3(Posit16E2 x)
        {
            ...
            public static explicit operator Posit32E4(Posit16E2 x)
        {
        ...
        public Posit16E2  Parse(string number) => new Posit16E2(Double.Parse(number));

        public bool TryParse(string number, out Posit16E2  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit16E2 (result);
            return returnValue;
        }

        public bool Equals(Posit16E2  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit16E2  posit) ? Equals(posit) : false;
