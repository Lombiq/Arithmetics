...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E2 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E2>, IComparable<Posit16E2>
    {
        ...
        public static Posit16E2 operator +(Posit16E2 left, Posit16E2 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E2(
            ...
            var rightAbsoluteValue = new Posit16E2(
            ...
            {
                return new Posit16E2(0, fromBitMask: true);
            }
        ...
        public static Posit16E2 operator -(Posit16E2 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit16E2(x.PositBits, fromBitMask: true)
                : new Posit16E2(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit16E2 operator /(Posit16E2 left, Posit16E2 right)
        {
            if (right.IsZero()) return new Posit16E2(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit16E2 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit16E2 obj)
        {
        ...
        public Posit16E2 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit16E2 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit16E2 posit && Equals(posit);
