...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E2 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E2>, IComparable<Posit16E2>
    {
        ...
        public Posit16E2(int value) =>
            PositBits = value >= 0
                ? new Posit16E2((uint)value).PositBits
                : GetTwosComplement(new Posit16E2((uint)-value).PositBits);
        ...
        public Posit16E2(long value) =>
            PositBits = value >= 0
                ? new Posit16E2((ulong)value).PositBits
                : GetTwosComplement(new Posit16E2((ulong)-value).PositBits);
        ...
        public static Posit16E2 Abs(Posit16E2 input)
        {
            ...
            return new Posit16E2((ushort)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
