...
{
    public readonly struct Posit16E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E3>, IComparable<Posit16E3>
    {
        ...
        public Posit16E3(ushort bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit16E3(bits).PositBits;

        public Posit16E3(Quire q)
        {
        ...
        public Posit16E3(bool sign, short scaleFactor, ushort fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public Posit16E3(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public static Quire MultiplyIntoQuire(Posit16E3 left, Posit16E3 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit16E3 Abs(Posit16E3 input)
        {
            var signBit = input.PositBits >> (Size - 1);
            var maskOfSignBits = 0 - signBit;

            return new Posit16E3((ushort)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
        ...
        public static Posit16E3 Sqrt(Posit16E3 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit16E3(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit16E3(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (ushort) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit16E3 FusedSum(Posit16E3[] posits)
        {
            ...
            return new Posit16E3(resultQuire);
        }

        public static Quire FusedSum(Posit16E3[] posits, Quire startingValue)
        {
        ...
        public static Posit16E3 FusedDotProduct(Posit16E3[] positArray1, Posit16E3[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit16E3(NaNBitMask, true);
        ...
        public static Posit16E3 FusedMultiplyAdd(Posit16E3 a, Posit16E3 b, Posit16E3 c)
        {
            var positArray1 = new Posit16E3[2];
            var positArray2 = new Posit16E3[2];

            positArray1[0] = a;
            positArray1[1] = new Posit16E3(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit16E3 FusedAddMultiply(Posit16E3 a, Posit16E3 b, Posit16E3 c)
        {
            var positArray1 = new Posit16E3[2];
            var positArray2 = new Posit16E3[2];
        ...
        public static Posit16E3 FusedMultiplyMultiplySubtract(Posit16E3 a, Posit16E3 b, Posit16E3 c, Posit16E3 d)
        {
            var positArray1 = new Posit16E3[2];
            var positArray2 = new Posit16E3[2];
        ...
        public static Posit16E3 operator +(Posit16E3 left, Posit16E3 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E3((ushort)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit16E3((ushort)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit16E3(0, true);
            ...
            return new Posit16E3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, (uint)resultFractionBits), true);
        }

        public static Posit16E3 operator +(Posit16E3 left, int right) => left + new Posit16E3(right);

        public static Posit16E3 operator -(Posit16E3 left, Posit16E3 right) => left + -right;

        public static Posit16E3 operator -(Posit16E3 left, int right) => left - new Posit16E3(right);

        public static Posit16E3 operator -(Posit16E3 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit16E3(x.PositBits, true);
            return new Posit16E3(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit16E3 left, Posit16E3 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit16E3 left, Posit16E3 right)
        {
        ...
        public static bool operator !=(Posit16E3 left, Posit16E3 right) => !(left == right);

        public static Posit16E3 operator *(Posit16E3 left, int right) => left * new Posit16E3(right);

        public static Posit16E3 operator *(Posit16E3 left, Posit16E3 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit16E3(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit16E3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit16E3 operator /(Posit16E3 left, Posit16E3 right)
        {
            if (right.IsZero()) return new Posit16E3(NaNBitMask, true);
            if (left.IsZero()) return new Posit16E3(0);
        ...
        public static explicit operator int(Posit16E3 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit16E3 x)
        {
        ...
        public static explicit operator double(Posit16E3 x)
        {
        ...
        public static explicit operator Quire(Posit16E3 x)
        {
        ...
        public static explicit operator Posit8E0(Posit16E3 x)
        {
            ...
            public static explicit operator Posit8E1(Posit16E3 x)
        {
            ...
            public static explicit operator Posit8E2(Posit16E3 x)
        {
            ...
            public static explicit operator Posit8E3(Posit16E3 x)
        {
            ...
            public static explicit operator Posit8E4(Posit16E3 x)
        {
            ...
            public static explicit operator Posit16E0(Posit16E3 x)
        {
            ...
            public static explicit operator Posit16E1(Posit16E3 x)
        {
            ...
            public static explicit operator Posit16E2(Posit16E3 x)
        {
            ...
            public static explicit operator Posit16E4(Posit16E3 x)
        {
            ...
            public static explicit operator Posit32E0(Posit16E3 x)
        {
            ...
            public static explicit operator Posit32E1(Posit16E3 x)
        {
            ...
            public static explicit operator Posit32E2(Posit16E3 x)
        {
            ...
            public static explicit operator Posit32E3(Posit16E3 x)
        {
            ...
            public static explicit operator Posit32E4(Posit16E3 x)
        {
        ...
        public Posit16E3  Parse(string number) => new Posit16E3(Double.Parse(number));

        public bool TryParse(string number, out Posit16E3  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit16E3 (result);
            return returnValue;
        }

        public bool Equals(Posit16E3  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit16E3  posit) ? Equals(posit) : false;
