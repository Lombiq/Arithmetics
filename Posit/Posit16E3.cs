...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E3>, IComparable<Posit16E3>
    {
        ...
        public static Posit16E3 operator +(Posit16E3 left, Posit16E3 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E3(
            ...
            var rightAbsoluteValue = new Posit16E3(
            ...
            {
                return new Posit16E3(0, fromBitMask: true);
            }
        ...
        public static Posit16E3 operator -(Posit16E3 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit16E3(x.PositBits, fromBitMask: true)
                : new Posit16E3(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit16E3 operator /(Posit16E3 left, Posit16E3 right)
        {
            if (right.IsZero()) return new Posit16E3(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit16E3 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit16E3 obj)
        {
        ...
        public Posit16E3 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit16E3 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit16E3 posit && Equals(posit);
