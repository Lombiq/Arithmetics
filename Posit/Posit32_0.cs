...
{
	public readonly struct Posit32_0 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_0>, IComparable<Posit32_0>
	{
		...
		public Posit32_0(uint bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit32_0(bits).PositBits;

		public Posit32_0(Quire q)
		{
			...
			PositBits = AssemblePositBitsWithRounding(sign, resultRegimeKValue,   (uint )(q >> QuireSize - Size));
		}


		public Posit32_0(uint value)
		{
		...
		public  Posit32_0(int value)
		{
			PositBits = value >= 0 ? new Posit32_0((uint)value).PositBits : GetTwosComplement(new Posit32_0((uint)-value).PositBits);
		}

		public Posit32_0(ulong value)
		{
		...
		public  Posit32_0(long value)
		{
			PositBits = value >= 0 ? new Posit32_0((ulong)value).PositBits : GetTwosComplement(new Posit32_0((ulong)-value).PositBits);
		}

		public  Posit32_0(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit32_0(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit32_0(bool sign, short scaleFactor, uint fraction)
		{
		...
		public static uint  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  uint fractionBits)
		{
		...
		public static uint  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  ulong fractionBits)
		{
	...
	#region Methods to handle parts of the Posit 
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit32_0 Abs(Posit32_0 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit32_0((uint)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit32_0 Sqrt(Posit32_0 number)
		{
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit32_0(AssemblePositBitsWithRounding(false, resultRegimeKValue,    resultFractionBits), true);
		}
		...
		public static Posit32_0 FusedSum(Posit32_0[] posits)
		{
			...
			return new Posit32_0(resultQuire);
		}

		public static Quire FusedSum(Posit32_0[] posits, Quire startingValue)
		{
		...
		public static Posit32_0 FusedDotProduct(Posit32_0[] positArray1, Posit32_0[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit32_0(NaNBitMask, true);
		...
		public static Posit32_0 FusedMultiplyAdd(Posit32_0 a, Posit32_0 b, Posit32_0 c)
		{
			var positArray1 = new Posit32_0[2];
			var positArray2 = new Posit32_0[2];

			positArray1[0] = a;
			positArray1[1] = new Posit32_0(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit32_0 FusedAddMultiply(Posit32_0 a, Posit32_0 b, Posit32_0 c)
		{
			var positArray1 = new Posit32_0[2];
			var positArray2 = new Posit32_0[2];
		...
		public static Posit32_0 FusedMultiplyMultiplySubtract(Posit32_0 a, Posit32_0 b, Posit32_0 c, Posit32_0 d)
		{
			var positArray1 = new Posit32_0[2];
			var positArray2 = new Posit32_0[2];
		...
		public static Posit32_0 operator +(Posit32_0 left, Posit32_0 right)
		{
			...
			var leftAbsoluteValue = new Posit32_0((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit32_0((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (resultFractionBits == 0) return new Posit32_0(0, true);
			...
			return new Posit32_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  (ulong)resultFractionBits), true);
		}

		public static Posit32_0 operator +(Posit32_0 left, int right) => left + new Posit32_0(right);

		public static Posit32_0 operator -(Posit32_0 left, Posit32_0 right) => left + -right;

		public static Posit32_0 operator -(Posit32_0 left, int right) => left - new Posit32_0(right);

		public static Posit32_0 operator -(Posit32_0 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit32_0(x.PositBits, true);
			return new Posit32_0(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit32_0 left, Posit32_0 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit32_0 left, Posit32_0 right)
		{
		...
		public static bool operator !=(Posit32_0 left, Posit32_0 right) => !(left == right);

		public static Posit32_0 operator *(Posit32_0 left, int right) => left * new Posit32_0(right);

		public static Posit32_0 operator *(Posit32_0 left, Posit32_0 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit32_0(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			return new Posit32_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  longResultFractionBits), true);
		}
		...
		public static Posit32_0 operator /(Posit32_0 left, Posit32_0 right)
		{
			if (left.IsZero()) return new Posit32_0(0);
			if (right.IsZero()) return new Posit32_0(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static explicit operator float(Posit32_0 x)
		{
		...
		public static explicit operator double(Posit32_0 x)
		{
		...
		public static explicit operator Quire(Posit32_0 x)
		{
		...
		public static explicit operator Posit8_0(Posit32_0 x)
		{
			...
			public static explicit operator Posit8_1(Posit32_0 x)
		{
			...
			public static explicit operator Posit8_2(Posit32_0 x)
		{
			...
			public static explicit operator Posit8_3(Posit32_0 x)
		{
			...
			public static explicit operator Posit8_4(Posit32_0 x)
		{
			...
			public static explicit operator Posit16_0(Posit32_0 x)
		{
			...
			public static explicit operator Posit16_1(Posit32_0 x)
		{
			...
			public static explicit operator Posit16_2(Posit32_0 x)
		{
			...
			public static explicit operator Posit16_3(Posit32_0 x)
		{
			...
			public static explicit operator Posit16_4(Posit32_0 x)
		{
			...
			public static explicit operator Posit32_1(Posit32_0 x)
		{
			...
			public static explicit operator Posit32_2(Posit32_0 x)
		{
			...
			public static explicit operator Posit32_3(Posit32_0 x)
		{
			...
			public static explicit operator Posit32_4(Posit32_0 x)
		{
		...
		public Posit32_0  Parse(string number) => new Posit32_0(Double.Parse(number));

		public bool TryParse(string number, out Posit32_0  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit32_0 (result);
			return returnValue;
		}

		public bool Equals(Posit32_0  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit32_0  posit) ? Equals(posit) : false;
