...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit8_3 : IComparable, IConvertible, IFormattable, IEquatable<Posit8_3>, IComparable<Posit8_3>
	{
		...
		public  Posit8_3(long value)
		{
			PositBits = value >= 0 ? new Posit8_3((ulong)value).PositBits : GetTwosComplement(new Posit8_3((ulong)-value).PositBits);
		}
			...
			public  Posit8_3(bool sign, short scaleFactor, byte fraction)
		{
			...
			public  Posit8_3(bool sign, short scaleFactor, ushort fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
			if (resultExponentBits < 0)
			...
			public  Posit8_3(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
			if (resultExponentBits < 0)
	...
	#region Methods to handle parts of the Posit 
		...
		public static Posit8_3 Sqrt(Posit8_3 number)
		{
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit8_3(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (byte) resultExponentBits,  resultFractionBits), true);
		}
		...
		public static Posit8_3 operator +(Posit8_3 left, Posit8_3 right)
		{
			...
			return new Posit8_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
		}
		...
		public static Posit8_3 operator *(Posit8_3 left, Posit8_3 right)
		{
			...
			return new Posit8_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
		}
