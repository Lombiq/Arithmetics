...
{
	public readonly struct Posit8_0 : IComparable, IConvertible, IFormattable, IEquatable<Posit8_0>, IComparable<Posit8_0>
	{
		...
		public Posit8_0(byte bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit8_0(bits).PositBits;

		public Posit8_0(Quire q)
		{
		...
		public  Posit8_0(int value)
		{
			PositBits = value >= 0 ? new Posit8_0((uint)value).PositBits : GetTwosComplement(new Posit8_0((uint)-value).PositBits);
		}

		public Posit8_0(ulong value)
		{
		...
		public  Posit8_0(long value)
		{
			PositBits = value >= 0 ? new Posit8_0((ulong)value).PositBits : GetTwosComplement(new Posit8_0((ulong)-value).PositBits);
		}

		public  Posit8_0(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit8_0(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit8_0(bool sign, short scaleFactor, byte fraction)
		{
					PositBits = AssemblePositBitsWithRounding(sign, scaleFactor, fraction);

					}
			public  Posit8_0(bool sign, short scaleFactor, ushort fraction)
		{
					PositBits = AssemblePositBitsWithRounding(sign, scaleFactor, fraction);

					}
			public  Posit8_0(bool sign, short scaleFactor, uint fraction)
		{
					PositBits = AssemblePositBitsWithRounding(sign, scaleFactor, fraction);
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit8_0 left, Posit8_0 right)
		{
		...
		public static Posit8_0 Abs(Posit8_0 input)
		{
			...
			return new Posit8_0((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit8_0 Sqrt(Posit8_0 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit8_0(NaNBitMask, true);
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit8_0(AssemblePositBitsWithRounding(false, resultRegimeKValue,    resultFractionBits), true);
		}
		...
		public static Posit8_0 FusedSum(Posit8_0[] posits)
		{
			...
			return new Posit8_0(resultQuire);
		}

		public static Quire FusedSum(Posit8_0[] posits, Quire startingValue)
		{
		...
		public static Posit8_0 FusedDotProduct(Posit8_0[] positArray1, Posit8_0[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit8_0(NaNBitMask, true);
		...
		public static Posit8_0 FusedMultiplyAdd(Posit8_0 a, Posit8_0 b, Posit8_0 c)
		{
			var positArray1 = new Posit8_0[2];
			var positArray2 = new Posit8_0[2];

			positArray1[0] = a;
			positArray1[1] = new Posit8_0(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit8_0 FusedAddMultiply(Posit8_0 a, Posit8_0 b, Posit8_0 c)
		{
			var positArray1 = new Posit8_0[2];
			var positArray2 = new Posit8_0[2];
		...
		public static Posit8_0 FusedMultiplyMultiplySubtract(Posit8_0 a, Posit8_0 b, Posit8_0 c, Posit8_0 d)
		{
			var positArray1 = new Posit8_0[2];
			var positArray2 = new Posit8_0[2];
		...
		public static Posit8_0 operator +(Posit8_0 left, Posit8_0 right)
		{
			...
			var leftAbsoluteValue = new Posit8_0((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit8_0((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			return new Posit8_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  (ushort)resultFractionBits), true);
		}

		public static Posit8_0 operator +(Posit8_0 left, int right) => left + new Posit8_0(right);

		public static Posit8_0 operator -(Posit8_0 left, Posit8_0 right) => left + -right;

		public static Posit8_0 operator -(Posit8_0 left, int right) => left - new Posit8_0(right);

		public static Posit8_0 operator -(Posit8_0 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit8_0(x.PositBits, true);
			return new Posit8_0(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit8_0 left, Posit8_0 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit8_0 left, Posit8_0 right)
		{
		...
		public static bool operator !=(Posit8_0 left, Posit8_0 right) => !(left == right);

		public static Posit8_0 operator *(Posit8_0 left, int right) => left * new Posit8_0(right);

		public static Posit8_0 operator *(Posit8_0 left, Posit8_0 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit8_0(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			return new Posit8_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  longResultFractionBits), true);
		}
		...
		public static Posit8_0 operator /(Posit8_0 left, Posit8_0 right)
		{
			if (left.IsZero()) return new Posit8_0(0);
			if (right.IsZero()) return new Posit8_0(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static explicit operator int(Posit8_0 x)
		{
			uint result;
		...
		public static explicit operator float(Posit8_0 x)
		{
		...
		public static explicit operator double(Posit8_0 x)
		{
		...
		public static explicit operator Quire(Posit8_0 x)
		{
		...
		public int CompareTo(Posit8_0  value)
		{
		...
		public Posit8_0  Parse(string number) => new Posit8_0(Double.Parse(number));

		public bool TryParse(string number, out Posit8_0  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit8_0 (result);
			return returnValue;
		}

		public bool Equals(Posit8_0  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit8_0  posit) ? Equals(posit) : false;
