...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E3>, IComparable<Posit32E3>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit32E3((uint)value).PositBits : GetTwosComplement(new Posit32E3((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit32E3((ulong)value).PositBits : GetTwosComplement(new Posit32E3((ulong)-value).PositBits);
        }
