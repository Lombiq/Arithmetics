...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E3 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E3>, IComparable<Posit32E3>
    {
        ...
        public static Posit32E3 Abs(Posit32E3 input)
        {
            ...
            return new Posit32E3((uint)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
        ...
        public static Posit32E3 Sqrt(Posit32E3 number)
        {
            ...
            if (!number.IsPositive()) return new Posit32E3(NaNBitMask, fromBitMask: true);
        ...
        public static Posit32E3 FusedDotProduct(Posit32E3[] positArray1, Posit32E3[] positArray2)
        {
            ...
            {
                return new Posit32E3(NaNBitMask, fromBitMask: true);
            }
        ...
        public static Posit32E3 operator +(Posit32E3 left, Posit32E3 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E3(
            ...
            var rightAbsoluteValue = new Posit32E3(
            ...
            {
                return new Posit32E3(0, fromBitMask: true);
            }
        ...
        public static Posit32E3 operator -(Posit32E3 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit32E3(x.PositBits, fromBitMask: true)
                : new Posit32E3(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit32E3 operator /(Posit32E3 left, Posit32E3 right)
        {
            if (right.IsZero()) return new Posit32E3(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit32E3 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit32E3 obj)
        {
        ...
        public Posit32E3 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit32E3 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit32E3 posit && Equals(posit);
