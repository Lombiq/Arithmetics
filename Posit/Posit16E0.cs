...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E0>, IComparable<Posit16E0>
    {
        ...
        public static Posit16E0 operator +(Posit16E0 left, Posit16E0 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E0(
            ...
            var rightAbsoluteValue = new Posit16E0(
            ...
            {
                return new Posit16E0(0, fromBitMask: true);
            }
        ...
        public static Posit16E0 operator -(Posit16E0 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit16E0(x.PositBits, fromBitMask: true)
                : new Posit16E0(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit16E0 operator /(Posit16E0 left, Posit16E0 right)
        {
            if (right.IsZero()) return new Posit16E0(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit16E0 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit16E0 obj)
        {
        ...
        public Posit16E0 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit16E0 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit16E0 posit && Equals(posit);
