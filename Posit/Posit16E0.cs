...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E0>, IComparable<Posit16E0>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit16E0((uint)value).PositBits : GetTwosComplement(new Posit16E0((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit16E0((ulong)value).PositBits : GetTwosComplement(new Posit16E0((ulong)-value).PositBits);
        }
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Posit16E0 Abs(Posit16E0 input)
        {
            ...
            return new Posit16E0((ushort)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        {
            if (positArray1.Length != positArray2.Length) return new Posit16E0(NaNBitMask, true);
