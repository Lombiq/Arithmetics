...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E1>, IComparable<Posit8E1>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit8E1((uint)value).PositBits : GetTwosComplement(new Posit8E1((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit8E1((ulong)value).PositBits : GetTwosComplement(new Posit8E1((ulong)-value).PositBits);
        }
