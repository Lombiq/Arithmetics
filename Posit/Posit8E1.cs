...
{
    public readonly struct Posit8E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E1>, IComparable<Posit8E1>
    {
        ...
        public Posit8E1(byte bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit8E1(bits).PositBits;

        public Posit8E1(Quire q)
        {
        ...
        public Posit8E1(int value) =>
            PositBits = value >= 0
                ? new Posit8E1((uint)value).PositBits
                : GetTwosComplement(new Posit8E1((uint)-value).PositBits);

        public Posit8E1(ulong value)
        {
            if (value == 0)
            {
                PositBits = (byte)value;
        ...
        public Posit8E1(long value) =>
            PositBits = value >= 0
                ? new Posit8E1((ulong)value).PositBits
                : GetTwosComplement(new Posit8E1((ulong)-value).PositBits);

        public Posit8E1(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E1(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E1(bool sign, short scaleFactor, byte fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public Posit8E1(bool sign, short scaleFactor, ushort fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public Posit8E1(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public static Quire MultiplyIntoQuire(Posit8E1 left, Posit8E1 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit8E1 Abs(Posit8E1 input)
        {
            var signBit = input.PositBits >> (Size - 1);
            var maskOfSignBits = 0 - signBit;

            return new Posit8E1((byte)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }
        ...
        public static Posit8E1 Sqrt(Posit8E1 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit8E1(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit8E1(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (byte) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit8E1 FusedSum(Posit8E1[] posits)
        {
            ...
            return new Posit8E1(resultQuire);
        }

        public static Quire FusedSum(Posit8E1[] posits, Quire startingValue)
        {
        ...
        public static Posit8E1 FusedDotProduct(Posit8E1[] positArray1, Posit8E1[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit8E1(NaNBitMask, true);
        ...
        public static Posit8E1 FusedMultiplyAdd(Posit8E1 a, Posit8E1 b, Posit8E1 c)
        {
            var positArray1 = new Posit8E1[2];
            var positArray2 = new Posit8E1[2];

            positArray1[0] = a;
            positArray1[1] = new Posit8E1(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit8E1 FusedAddMultiply(Posit8E1 a, Posit8E1 b, Posit8E1 c)
        {
            var positArray1 = new Posit8E1[2];
            var positArray2 = new Posit8E1[2];
        ...
        public static Posit8E1 FusedMultiplyMultiplySubtract(Posit8E1 a, Posit8E1 b, Posit8E1 c, Posit8E1 d)
        {
            var positArray1 = new Posit8E1[2];
            var positArray2 = new Posit8E1[2];
        ...
        public static Posit8E1 operator -(Posit8E1 left, Posit8E1 right) => left + -right;
        ...
        public static bool operator >(Posit8E1 left, Posit8E1 right)
        {
        ...
        public static bool operator !=(Posit8E1 left, Posit8E1 right) => !(left == right);

        public static Posit8E1 operator *(Posit8E1 left, int right) => left * new Posit8E1(right);

        public static Posit8E1 operator *(Posit8E1 left, Posit8E1 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit8E1(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
        ...
        public static explicit operator float(Posit8E1 x)
        {
        ...
        public static explicit operator double(Posit8E1 x)
        {
