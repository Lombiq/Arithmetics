...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit16_0 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_0>, IComparable<Posit16_0>
	{
		...
		public static Posit16_0 Sqrt(Posit16_0 number)
		{
			...
			return new Posit16_0(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_0 operator +(Posit16_0 left, Posit16_0 right)
		{
			...
			return new Posit16_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_0 operator /(Posit16_0 left, Posit16_0 right)
		{
			...
			return new Posit16_0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort)resultExponentBits, resultFractionBits), true);
		}
