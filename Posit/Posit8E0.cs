...
{
    public readonly struct Posit8E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E0>, IComparable<Posit8E0>
    {
        ...
        public const ushort QuireSize = 64;
        ...
        public Posit8E0(byte bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit8E0(bits).PositBits;

        public Posit8E0(Quire q)
        {
            ...
            PositBits = AssemblePositBitsWithRounding(sign, resultRegimeKValue,   (byte )(q >> QuireSize - Size));
        }


        public Posit8E0(uint value)
        {
        ...
        public  Posit8E0(int value)
        {
            PositBits = value >= 0 ? new Posit8E0((uint)value).PositBits : GetTwosComplement(new Posit8E0((uint)-value).PositBits);
        }

        public Posit8E0(ulong value)
        {
        ...
        public  Posit8E0(long value)
        {
            PositBits = value >= 0 ? new Posit8E0((ulong)value).PositBits : GetTwosComplement(new Posit8E0((ulong)-value).PositBits);
        }

        public  Posit8E0(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E0(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  byte fractionBits)
        {
        ...
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  ushort fractionBits)
        {
        ...
        //This method is necessary for conversions from posits wiht bigger underlying structures. 
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  uint fractionBits)
        {
        ...
        //This method is necessary for conversions from posits wiht bigger underlying structures. 
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,  ulong fractionBits)
        {
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Quire MultiplyIntoQuire(Posit8E0 left, Posit8E0 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit8E0 Abs(Posit8E0 input)
        {
            var signBit = input.PositBits >> Size - 1;
            var maskOfSignBits = 0 - signBit;
            return new Posit8E0((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit8E0 Sqrt(Posit8E0 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit8E0(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit8E0(AssemblePositBitsWithRounding(false, resultRegimeKValue,    resultFractionBits), true);
        }
        ...
        public static Posit8E0 FusedSum(Posit8E0[] posits)
        {
            ...
            return new Posit8E0(resultQuire);
        }

        public static Quire FusedSum(Posit8E0[] posits, Quire startingValue)
        {
        ...
        public static Posit8E0 FusedDotProduct(Posit8E0[] positArray1, Posit8E0[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit8E0(NaNBitMask, true);
        ...
        public static Posit8E0 FusedMultiplyAdd(Posit8E0 a, Posit8E0 b, Posit8E0 c)
        {
            var positArray1 = new Posit8E0[2];
            var positArray2 = new Posit8E0[2];

            positArray1[0] = a;
            positArray1[1] = new Posit8E0(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit8E0 FusedAddMultiply(Posit8E0 a, Posit8E0 b, Posit8E0 c)
        {
            var positArray1 = new Posit8E0[2];
            var positArray2 = new Posit8E0[2];
        ...
        public static Posit8E0 FusedMultiplyMultiplySubtract(Posit8E0 a, Posit8E0 b, Posit8E0 c, Posit8E0 d)
        {
            var positArray1 = new Posit8E0[2];
            var positArray2 = new Posit8E0[2];
        ...
        public static Posit8E0 operator +(Posit8E0 left, Posit8E0 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E0((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit8E0((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit8E0(0, true);
            ...
            return new Posit8E0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  (ushort)resultFractionBits), true);
        }

        public static Posit8E0 operator +(Posit8E0 left, int right) => left + new Posit8E0(right);

        public static Posit8E0 operator -(Posit8E0 left, Posit8E0 right) => left + -right;

        public static Posit8E0 operator -(Posit8E0 left, int right) => left - new Posit8E0(right);

        public static Posit8E0 operator -(Posit8E0 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit8E0(x.PositBits, true);
            return new Posit8E0(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit8E0 left, Posit8E0 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit8E0 left, Posit8E0 right)
        {
        ...
        public static bool operator !=(Posit8E0 left, Posit8E0 right) => !(left == right);

        public static Posit8E0 operator *(Posit8E0 left, int right) => left * new Posit8E0(right);

        public static Posit8E0 operator *(Posit8E0 left, Posit8E0 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit8E0(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit8E0(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,  longResultFractionBits), true);
        }
        ...
        public static Posit8E0 operator /(Posit8E0 left, Posit8E0 right)
        {
            if (right.IsZero()) return new Posit8E0(NaNBitMask, true);
            if (left.IsZero()) return new Posit8E0(0);
        ...
        public static explicit operator int(Posit8E0 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit8E0 x)
        {
        ...
        public static explicit operator double(Posit8E0 x)
        {
        ...
        public static explicit operator Quire(Posit8E0 x)
        {
        ...
        public static explicit operator Posit8E1(Posit8E0 x)
        {
            ...
            public static explicit operator Posit8E2(Posit8E0 x)
        {
            ...
            public static explicit operator Posit8E3(Posit8E0 x)
        {
            ...
            public static explicit operator Posit8E4(Posit8E0 x)
        {
            ...
            public static explicit operator Posit16E0(Posit8E0 x)
        {
            ...
            public static explicit operator Posit16E1(Posit8E0 x)
        {
            ...
            public static explicit operator Posit16E2(Posit8E0 x)
        {
            ...
            public static explicit operator Posit16E3(Posit8E0 x)
        {
            ...
            public static explicit operator Posit16E4(Posit8E0 x)
        {
            ...
            public static explicit operator Posit32E0(Posit8E0 x)
        {
            ...
            public static explicit operator Posit32E1(Posit8E0 x)
        {
            ...
            public static explicit operator Posit32E2(Posit8E0 x)
        {
            ...
            public static explicit operator Posit32E3(Posit8E0 x)
        {
            ...
            public static explicit operator Posit32E4(Posit8E0 x)
        {
        ...
        public int CompareTo(Posit8E0  value)
        {
        ...
        public Posit8E0  Parse(string number) => new Posit8E0(Double.Parse(number));

        public bool TryParse(string number, out Posit8E0  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit8E0 (result);
            return returnValue;
        }

        public bool Equals(Posit8E0  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit8E0  posit) ? Equals(posit) : false;
