...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E0 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E0>, IComparable<Posit8E0>
    {
        ...
        public static Posit8E0 operator +(Posit8E0 left, Posit8E0 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E0(
            ...
            var rightAbsoluteValue = new Posit8E0(
            ...
            {
                return new Posit8E0(0, fromBitMask: true);
            }
        ...
        public static Posit8E0 operator -(Posit8E0 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit8E0(x.PositBits, fromBitMask: true)
                : new Posit8E0(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit8E0 operator /(Posit8E0 left, Posit8E0 right)
        {
            if (right.IsZero()) return new Posit8E0(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit8E0 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit8E0 obj)
        {
        ...
        public Posit8E0 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit8E0 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit8E0 posit && Equals(posit);
