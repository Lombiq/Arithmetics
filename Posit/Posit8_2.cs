...
{
    public readonly struct Posit8_2 : IComparable, IConvertible, IFormattable, IEquatable<Posit8_2>, IComparable<Posit8_2>
    {
        ...
        public Posit8_2(byte bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit8_2(bits).PositBits;

        public Posit8_2(Quire q)
        {
        ...
        public  Posit8_2(int value)
        {
            PositBits = value >= 0 ? new Posit8_2((uint)value).PositBits : GetTwosComplement(new Posit8_2((uint)-value).PositBits);
        }

        public Posit8_2(ulong value)
        {
        ...
        public  Posit8_2(long value)
        {
            PositBits = value >= 0 ? new Posit8_2((ulong)value).PositBits : GetTwosComplement(new Posit8_2((ulong)-value).PositBits);
        }

        public  Posit8_2(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8_2(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        #region Posit constructors for Posit conversions
            ...
            public  Posit8_2(bool sign, short scaleFactor, byte fraction)
        {
                    var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            ...
            public  Posit8_2(bool sign, short scaleFactor, ushort fraction)
        {
                    var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
            if (resultExponentBits < 0)
            ...
            public  Posit8_2(bool sign, short scaleFactor, uint fraction)
        {
                    var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
            if (resultExponentBits < 0)
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Quire MultiplyIntoQuire(Posit8_2 left, Posit8_2 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit8_2 Abs(Posit8_2 input)
        {
            var signBit = input.PositBits >> Size - 1;
            var maskOfSignBits = 0 - signBit;
            return new Posit8_2((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit8_2 Sqrt(Posit8_2 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit8_2(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit8_2(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (byte) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit8_2 FusedSum(Posit8_2[] posits)
        {
            ...
            return new Posit8_2(resultQuire);
        }

        public static Quire FusedSum(Posit8_2[] posits, Quire startingValue)
        {
        ...
        public static Posit8_2 FusedDotProduct(Posit8_2[] positArray1, Posit8_2[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit8_2(NaNBitMask, true);
        ...
        public static Posit8_2 FusedMultiplyAdd(Posit8_2 a, Posit8_2 b, Posit8_2 c)
        {
            var positArray1 = new Posit8_2[2];
            var positArray2 = new Posit8_2[2];

            positArray1[0] = a;
            positArray1[1] = new Posit8_2(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit8_2 FusedAddMultiply(Posit8_2 a, Posit8_2 b, Posit8_2 c)
        {
            var positArray1 = new Posit8_2[2];
            var positArray2 = new Posit8_2[2];
        ...
        public static Posit8_2 FusedMultiplyMultiplySubtract(Posit8_2 a, Posit8_2 b, Posit8_2 c, Posit8_2 d)
        {
            var positArray1 = new Posit8_2[2];
            var positArray2 = new Posit8_2[2];
        ...
        public static Posit8_2 operator +(Posit8_2 left, Posit8_2 right)
        {
            ...
            var leftAbsoluteValue = new Posit8_2((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit8_2((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            return new Posit8_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
        }

        public static Posit8_2 operator +(Posit8_2 left, int right) => left + new Posit8_2(right);

        public static Posit8_2 operator -(Posit8_2 left, Posit8_2 right) => left + -right;

        public static Posit8_2 operator -(Posit8_2 left, int right) => left - new Posit8_2(right);

        public static Posit8_2 operator -(Posit8_2 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit8_2(x.PositBits, true);
            return new Posit8_2(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit8_2 left, Posit8_2 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit8_2 left, Posit8_2 right)
        {
        ...
        public static bool operator !=(Posit8_2 left, Posit8_2 right) => !(left == right);

        public static Posit8_2 operator *(Posit8_2 left, int right) => left * new Posit8_2(right);

        public static Posit8_2 operator *(Posit8_2 left, Posit8_2 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit8_2(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit8_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static explicit operator int(Posit8_2 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit8_2 x)
        {
        ...
        public static explicit operator double(Posit8_2 x)
        {
        ...
        public static explicit operator Quire(Posit8_2 x)
        {
        ...
        public static explicit operator Posit8_0(Posit8_2 x)
        {
            ...
            public static explicit operator Posit8_1(Posit8_2 x)
        {
            ...
            public static explicit operator Posit8_3(Posit8_2 x)
        {
            ...
            public static explicit operator Posit8_4(Posit8_2 x)
        {
            ...
            public static explicit operator Posit16_0(Posit8_2 x)
        {
            ...
            public static explicit operator Posit16_1(Posit8_2 x)
        {
            ...
            public static explicit operator Posit16_2(Posit8_2 x)
        {
            ...
            public static explicit operator Posit16_3(Posit8_2 x)
        {
            ...
            public static explicit operator Posit16_4(Posit8_2 x)
        {
            ...
            public static explicit operator Posit32_0(Posit8_2 x)
        {
            ...
            public static explicit operator Posit32_1(Posit8_2 x)
        {
            ...
            public static explicit operator Posit32_2(Posit8_2 x)
        {
            ...
            public static explicit operator Posit32_3(Posit8_2 x)
        {
            ...
            public static explicit operator Posit32_4(Posit8_2 x)
        {
        ...
        public int CompareTo(Posit8_2  value)
        {
        ...
        public Posit8_2  Parse(string number) => new Posit8_2(Double.Parse(number));

        public bool TryParse(string number, out Posit8_2  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit8_2 (result);
            return returnValue;
        }

        public bool Equals(Posit8_2  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit8_2  posit) ? Equals(posit) : false;
