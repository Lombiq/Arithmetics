...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit32_2 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_2>, IComparable<Posit32_2>
	{
		...
		public static Posit32_2 Sqrt(Posit32_2 number)
		{
			...
			return new Posit32_2(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit32_2 operator +(Posit32_2 left, Posit32_2 right)
		{
			...
			return new Posit32_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
