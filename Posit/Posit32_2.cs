...
namespace Lombiq.Arithmetics
{
	...
	#region Methods to handle parts of the Posit 
		...
		public static Posit32_2 operator +(Posit32_2 left, Posit32_2 right)
		{
			...
			return new Posit32_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, (ulong)resultFractionBits), true);
		}
		...
		public static Posit32_2 operator *(Posit32_2 left, Posit32_2 right)
		{
			...
			return new Posit32_2(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, longResultFractionBits), true);
		}
