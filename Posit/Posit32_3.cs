	...
	public readonly struct Posit32_3 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_3>, IComparable<Posit32_3>
	{
		...
		public uint FractionWithHiddenBit()
		{
			...
			var result = (uint)((uint)(bits << (int)(Size - fractionSize))
						 >> (int)(Size - fractionSize));
			return fractionSize == 0 ? (uint)1 : SetOne(result, (ushort)fractionSize);
		}
		...
		public static Posit32_3 operator /(Posit32_3 left, Posit32_3 right)
		{
			...
			return new Posit32_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue,(uint) (uint)resultExponentBits, resultFractionBits), true);
		}
