...
{
	public readonly struct Posit32_3 : IComparable, IConvertible, IFormattable, IEquatable<Posit32_3>, IComparable<Posit32_3>
	{
		...
		public Posit32_3(uint bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit32_3(bits).PositBits;

		public Posit32_3(Quire q)
		{
		...
		public  Posit32_3(int value)
		{
			PositBits = value >= 0 ? new Posit32_3((uint)value).PositBits : GetTwosComplement(new Posit32_3((uint)-value).PositBits);
		}

		public Posit32_3(ulong value)
		{
		...
		public  Posit32_3(long value)
		{
			PositBits = value >= 0 ? new Posit32_3((ulong)value).PositBits : GetTwosComplement(new Posit32_3((ulong)-value).PositBits);
		}

		public  Posit32_3(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit32_3(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit32_3(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit32_3 left, Posit32_3 right)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit32_3 Abs(Posit32_3 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit32_3((uint)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit32_3 Sqrt(Posit32_3 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit32_3(NaNBitMask, true);
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit32_3(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (uint) resultExponentBits,  resultFractionBits), true);
		}
		...
		public static Posit32_3 FusedSum(Posit32_3[] posits)
		{
			...
			return new Posit32_3(resultQuire);
		}

		public static Quire FusedSum(Posit32_3[] posits, Quire startingValue)
		{
		...
		public static Posit32_3 FusedDotProduct(Posit32_3[] positArray1, Posit32_3[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit32_3(NaNBitMask, true);
		...
		public static Posit32_3 FusedMultiplyAdd(Posit32_3 a, Posit32_3 b, Posit32_3 c)
		{
			var positArray1 = new Posit32_3[2];
			var positArray2 = new Posit32_3[2];

			positArray1[0] = a;
			positArray1[1] = new Posit32_3(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit32_3 FusedAddMultiply(Posit32_3 a, Posit32_3 b, Posit32_3 c)
		{
			var positArray1 = new Posit32_3[2];
			var positArray2 = new Posit32_3[2];
		...
		public static Posit32_3 FusedMultiplyMultiplySubtract(Posit32_3 a, Posit32_3 b, Posit32_3 c, Posit32_3 d)
		{
			var positArray1 = new Posit32_3[2];
			var positArray2 = new Posit32_3[2];
		...
		public static Posit32_3 operator +(Posit32_3 left, Posit32_3 right)
		{
			...
			var leftAbsoluteValue = new Posit32_3((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit32_3((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (resultFractionBits == 0) return new Posit32_3(0, true);
			...
			return new Posit32_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, (ulong)resultFractionBits), true);
		}

		public static Posit32_3 operator +(Posit32_3 left, int right) => left + new Posit32_3(right);

		public static Posit32_3 operator -(Posit32_3 left, Posit32_3 right) => left + -right;

		public static Posit32_3 operator -(Posit32_3 left, int right) => left - new Posit32_3(right);

		public static Posit32_3 operator -(Posit32_3 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit32_3(x.PositBits, true);
			return new Posit32_3(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit32_3 left, Posit32_3 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit32_3 left, Posit32_3 right)
		{
		...
		public static bool operator !=(Posit32_3 left, Posit32_3 right) => !(left == right);

		public static Posit32_3 operator *(Posit32_3 left, int right) => left * new Posit32_3(right);

		public static Posit32_3 operator *(Posit32_3 left, Posit32_3 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit32_3(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			return new Posit32_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, longResultFractionBits), true);
		}
		...
		public static Posit32_3 operator /(Posit32_3 left, Posit32_3 right)
		{
			if (left.IsZero()) return new Posit32_3(0);
			if (right.IsZero()) return new Posit32_3(NaNBitMask, true);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
		...
		public static explicit operator int(Posit32_3 x)
		{
			uint result;
		...
		public static explicit operator float(Posit32_3 x)
		{
		...
		public static explicit operator double(Posit32_3 x)
		{
		...
		public static explicit operator Quire(Posit32_3 x)
		{
		...
		public static explicit operator Posit8_0(Posit32_3 x)
		{
			...
			public static explicit operator Posit8_1(Posit32_3 x)
		{
			...
			public static explicit operator Posit8_2(Posit32_3 x)
		{
			...
			public static explicit operator Posit8_3(Posit32_3 x)
		{
			...
			public static explicit operator Posit8_4(Posit32_3 x)
		{
			...
			public static explicit operator Posit16_0(Posit32_3 x)
		{
			...
			public static explicit operator Posit16_1(Posit32_3 x)
		{
			...
			public static explicit operator Posit16_2(Posit32_3 x)
		{
			...
			public static explicit operator Posit16_3(Posit32_3 x)
		{
			...
			public static explicit operator Posit16_4(Posit32_3 x)
		{
			...
			public static explicit operator Posit32_0(Posit32_3 x)
		{
			...
			public static explicit operator Posit32_1(Posit32_3 x)
		{
			...
			public static explicit operator Posit32_2(Posit32_3 x)
		{
			...
			public static explicit operator Posit32_4(Posit32_3 x)
		{
		...
		public Posit32_3  Parse(string number) => new Posit32_3(Double.Parse(number));

		public bool TryParse(string number, out Posit32_3  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit32_3 (result);
			return returnValue;
		}

		public bool Equals(Posit32_3  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit32_3  posit) ? Equals(posit) : false;
