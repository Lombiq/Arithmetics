...
namespace Lombiq.Arithmetics
{
	...
	#region Methods to handle parts of the Posit 
		...
		public static Posit8_1 operator +(Posit8_1 left, Posit8_1 right)
		{
			...
			return new Posit8_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
		}
		...
		public static Posit8_1 operator *(Posit8_1 left, Posit8_1 right)
		{
			...
			return new Posit8_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
		}
