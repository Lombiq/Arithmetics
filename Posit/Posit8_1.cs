...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit8_1 : IComparable, IConvertible, IFormattable, IEquatable<Posit8_1>, IComparable<Posit8_1>
	{
		...
		public static Posit8_1 Sqrt(Posit8_1 number)
		{
			...
			return new Posit8_1(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit8_1 operator +(Posit8_1 left, Posit8_1 right)
		{
			...
			return new Posit8_1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
