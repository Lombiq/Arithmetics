...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E4>, IComparable<Posit8E4>
    {
        ...
        public static Posit8E4 operator +(Posit8E4 left, Posit8E4 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E4(
            ...
            var rightAbsoluteValue = new Posit8E4(
            ...
            {
                return new Posit8E4(0, fromBitMask: true);
            }
        ...
        public static Posit8E4 operator -(Posit8E4 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit8E4(x.PositBits, fromBitMask: true)
                : new Posit8E4(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit8E4 operator /(Posit8E4 left, Posit8E4 right)
        {
            if (right.IsZero()) return new Posit8E4(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit8E4 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit8E4 obj)
        {
        ...
        public Posit8E4 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit8E4 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit8E4 posit && Equals(posit);
