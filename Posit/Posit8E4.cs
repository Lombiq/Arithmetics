...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E4>, IComparable<Posit8E4>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit8E4((uint)value).PositBits : GetTwosComplement(new Posit8E4((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit8E4((ulong)value).PositBits : GetTwosComplement(new Posit8E4((ulong)-value).PositBits);
        }
