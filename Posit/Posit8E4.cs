...
{
    public readonly struct Posit8E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E4>, IComparable<Posit8E4>
    {
        ...
        public Posit8E4(byte bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit8E4(bits).PositBits;

        public Posit8E4(Quire q)
        {
        ...
        public Posit8E4(int value) =>
            PositBits = value >= 0
                ? new Posit8E4((uint)value).PositBits
                : GetTwosComplement(new Posit8E4((uint)-value).PositBits);

        public Posit8E4(ulong value)
        {
            if (value == 0)
            {
                PositBits = (byte)value;
        ...
        public Posit8E4(long value) =>
            PositBits = value >= 0
                ? new Posit8E4((ulong)value).PositBits
                : GetTwosComplement(new Posit8E4((ulong)-value).PositBits);

        public Posit8E4(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E4(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit8E4(bool sign, short scaleFactor, byte fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public Posit8E4(bool sign, short scaleFactor, ushort fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
        ...
        public Posit8E4(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
            var resultExponentBits = scaleFactor % (1 << MaximumExponentSize);
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Quire MultiplyIntoQuire(Posit8E4 left, Posit8E4 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit8E4 Abs(Posit8E4 input)
        {
            var signBit = input.PositBits >> Size - 1;
            var maskOfSignBits = 0 - signBit;
            return new Posit8E4((byte)((input.PositBits ^ maskOfSignBits) + signBit), true);
        }		
        ...
        public static Posit8E4 FusedSum(Posit8E4[] posits)
        {
            ...
            return new Posit8E4(resultQuire);
        }

        public static Quire FusedSum(Posit8E4[] posits, Quire startingValue)
        {
        ...
        public static Posit8E4 FusedDotProduct(Posit8E4[] positArray1, Posit8E4[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit8E4(NaNBitMask, true);
        ...
        public static Posit8E4 FusedMultiplyAdd(Posit8E4 a, Posit8E4 b, Posit8E4 c)
        {
            var positArray1 = new Posit8E4[2];
            var positArray2 = new Posit8E4[2];

            positArray1[0] = a;
            positArray1[1] = new Posit8E4(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit8E4 FusedAddMultiply(Posit8E4 a, Posit8E4 b, Posit8E4 c)
        {
            var positArray1 = new Posit8E4[2];
            var positArray2 = new Posit8E4[2];
        ...
        public static Posit8E4 FusedMultiplyMultiplySubtract(Posit8E4 a, Posit8E4 b, Posit8E4 c, Posit8E4 d)
        {
            var positArray1 = new Posit8E4[2];
            var positArray2 = new Posit8E4[2];
        ...
        public static Posit8E4 operator +(Posit8E4 left, Posit8E4 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E4((byte)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit8E4((byte)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit8E4(0, true);
            ...
            return new Posit8E4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, (ushort)resultFractionBits), true);
        }

        public static Posit8E4 operator +(Posit8E4 left, int right) => left + new Posit8E4(right);

        public static Posit8E4 operator -(Posit8E4 left, Posit8E4 right) => left + -right;

        public static Posit8E4 operator -(Posit8E4 left, int right) => left - new Posit8E4(right);

        public static Posit8E4 operator -(Posit8E4 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit8E4(x.PositBits, true);
            return new Posit8E4(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit8E4 left, Posit8E4 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit8E4 left, Posit8E4 right)
        {
        ...
        public static bool operator !=(Posit8E4 left, Posit8E4 right) => !(left == right);

        public static Posit8E4 operator *(Posit8E4 left, int right) => left * new Posit8E4(right);

        public static Posit8E4 operator *(Posit8E4 left, Posit8E4 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit8E4(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit8E4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (byte) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit8E4 operator /(Posit8E4 left, Posit8E4 right)
        {
            if (right.IsZero()) return new Posit8E4(NaNBitMask, true);
            if (left.IsZero()) return new Posit8E4(0);
        ...
        public static explicit operator int(Posit8E4 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit8E4 x)
        {
        ...
        public static explicit operator double(Posit8E4 x)
        {
        ...
        public static explicit operator Quire(Posit8E4 x)
        {
        ...
        public static explicit operator Posit8E0(Posit8E4 x)
        {
            ...
            public static explicit operator Posit8E1(Posit8E4 x)
        {
            ...
            public static explicit operator Posit8E2(Posit8E4 x)
        {
            ...
            public static explicit operator Posit8E3(Posit8E4 x)
        {
            ...
            public static explicit operator Posit16E0(Posit8E4 x)
        {
            ...
            public static explicit operator Posit16E1(Posit8E4 x)
        {
            ...
            public static explicit operator Posit16E2(Posit8E4 x)
        {
            ...
            public static explicit operator Posit16E3(Posit8E4 x)
        {
            ...
            public static explicit operator Posit16E4(Posit8E4 x)
        {
            ...
            public static explicit operator Posit32E0(Posit8E4 x)
        {
            ...
            public static explicit operator Posit32E1(Posit8E4 x)
        {
            ...
            public static explicit operator Posit32E2(Posit8E4 x)
        {
            ...
            public static explicit operator Posit32E3(Posit8E4 x)
        {
            ...
            public static explicit operator Posit32E4(Posit8E4 x)
        {
        ...
        public int CompareTo(Posit8E4  value)
        {
        ...
        public Posit8E4  Parse(string number) => new Posit8E4(Double.Parse(number));

        public bool TryParse(string number, out Posit8E4  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit8E4 (result);
            return returnValue;
        }

        public bool Equals(Posit8E4  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit8E4  posit) ? Equals(posit) : false;
