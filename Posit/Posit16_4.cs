...
{
	public readonly struct Posit16_4 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_4>, IComparable<Posit16_4>
	{
		...
		public Posit16_4(ushort bits, bool fromBitMask) =>
			PositBits = fromBitMask ? bits : new Posit16_4(bits).PositBits;

		public Posit16_4(Quire q)
		{
		...
		public  Posit16_4(int value)
		{
			PositBits = value >= 0 ? new Posit16_4((uint)value).PositBits : GetTwosComplement(new Posit16_4((uint)-value).PositBits);
		}

		public Posit16_4(ulong value)
		{
		...
		public  Posit16_4(long value)
		{
			PositBits = value >= 0 ? new Posit16_4((ulong)value).PositBits : GetTwosComplement(new Posit16_4((ulong)-value).PositBits);
		}

		public  Posit16_4(float floatBits)
		{
			PositBits = NaNBitMask;
		...
		public Posit16_4(double doubleBits)
		{
			PositBits = NaNBitMask;
		...
		#region Posit constructors for Posit conversions
			...
			public  Posit16_4(bool sign, short scaleFactor, ushort fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			...
			public  Posit16_4(bool sign, short scaleFactor, uint fraction)
		{
					var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
			var resultExponentBits =  (scaleFactor % (1 << MaximumExponentSize));
			if (resultExponentBits < 0)
	...
	#region Methods to handle parts of the Posit 
		...
		public static Quire MultiplyIntoQuire(Posit16_4 left, Posit16_4 right)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Posit16_4 Abs(Posit16_4 input)
		{
			var signBit = input.PositBits >> Size - 1;
			var maskOfSignBits = 0 - signBit;
			return new Posit16_4((ushort)((input.PositBits ^ maskOfSignBits) + signBit), true);
		}		
		...
		public static Posit16_4 Sqrt(Posit16_4 number)
		{
			if (number.IsNaN() || number.IsZero()) return number;
			if (!number.IsPositive()) return new Posit16_4(NaNBitMask, true);
			...
			while (estimateMaskingBit != 0)
			{
				...
				return new Posit16_4(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (ushort) resultExponentBits,  resultFractionBits), true);
		}
		...
		public static Posit16_4 FusedSum(Posit16_4[] posits)
		{
			...
			return new Posit16_4(resultQuire);
		}

		public static Quire FusedSum(Posit16_4[] posits, Quire startingValue)
		{
		...
		public static Posit16_4 FusedDotProduct(Posit16_4[] positArray1, Posit16_4[] positArray2)
		{
			if (positArray1.Length != positArray2.Length) return new Posit16_4(NaNBitMask, true);
		...
		public static Posit16_4 FusedMultiplyAdd(Posit16_4 a, Posit16_4 b, Posit16_4 c)
		{
			var positArray1 = new Posit16_4[2];
			var positArray2 = new Posit16_4[2];

			positArray1[0] = a;
			positArray1[1] = new Posit16_4(1);
			positArray2[0] = b;
			positArray2[1] = c;
		...
		public static Posit16_4 FusedAddMultiply(Posit16_4 a, Posit16_4 b, Posit16_4 c)
		{
			var positArray1 = new Posit16_4[2];
			var positArray2 = new Posit16_4[2];
		...
		public static Posit16_4 FusedMultiplyMultiplySubtract(Posit16_4 a, Posit16_4 b, Posit16_4 c, Posit16_4 d)
		{
			var positArray1 = new Posit16_4[2];
			var positArray2 = new Posit16_4[2];
		...
		public static Posit16_4 operator +(Posit16_4 left, Posit16_4 right)
		{
			...
			var leftAbsoluteValue = new Posit16_4((ushort)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

			var rightSignBit = right.PositBits >> Size - 1;
			var rightMaskOfSignBits = 0 - rightSignBit;
			var rightAbsoluteValue = new Posit16_4((ushort)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
			...
			if (resultFractionBits == 0) return new Posit16_4(0, true);
			...
			return new Posit16_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, (uint)resultFractionBits), true);
		}

		public static Posit16_4 operator +(Posit16_4 left, int right) => left + new Posit16_4(right);

		public static Posit16_4 operator -(Posit16_4 left, Posit16_4 right) => left + -right;

		public static Posit16_4 operator -(Posit16_4 left, int right) => left - new Posit16_4(right);

		public static Posit16_4 operator -(Posit16_4 x)
		{
			if (x.IsNaN() || x.IsZero()) return new Posit16_4(x.PositBits, true);
			return new Posit16_4(GetTwosComplement(x.PositBits), true);
		}

		public static bool operator ==(Posit16_4 left, Posit16_4 right) => left.PositBits == right.PositBits;

		public static bool operator >(Posit16_4 left, Posit16_4 right)
		{
		...
		public static bool operator !=(Posit16_4 left, Posit16_4 right) => !(left == right);

		public static Posit16_4 operator *(Posit16_4 left, int right) => left * new Posit16_4(right);

		public static Posit16_4 operator *(Posit16_4 left, Posit16_4 right)
		{
			if (left.IsZero() || right.IsZero()) return new Posit16_4(0);
			var leftIsPositive = left.IsPositive();
			var rightIsPositive = right.IsPositive();
			var resultSignBit = leftIsPositive != rightIsPositive;
			...
			return new Posit16_4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, longResultFractionBits), true);
		}
		...
		public static Posit16_4 operator /(Posit16_4 left, Posit16_4 right)
		{
			if (right.IsZero()) return new Posit16_4(NaNBitMask, true);
			if (left.IsZero()) return new Posit16_4(0);
		...
		public static explicit operator int(Posit16_4 x)
		{
			uint result;
		...
		public static explicit operator float(Posit16_4 x)
		{
		...
		public static explicit operator double(Posit16_4 x)
		{
		...
		public static explicit operator Quire(Posit16_4 x)
		{
		...
		public static explicit operator Posit8_0(Posit16_4 x)
		{
			...
			public static explicit operator Posit8_1(Posit16_4 x)
		{
			...
			public static explicit operator Posit8_2(Posit16_4 x)
		{
			...
			public static explicit operator Posit8_3(Posit16_4 x)
		{
			...
			public static explicit operator Posit8_4(Posit16_4 x)
		{
			...
			public static explicit operator Posit16_0(Posit16_4 x)
		{
			...
			public static explicit operator Posit16_1(Posit16_4 x)
		{
			...
			public static explicit operator Posit16_2(Posit16_4 x)
		{
			...
			public static explicit operator Posit16_3(Posit16_4 x)
		{
			...
			public static explicit operator Posit32_0(Posit16_4 x)
		{
			...
			public static explicit operator Posit32_1(Posit16_4 x)
		{
			...
			public static explicit operator Posit32_2(Posit16_4 x)
		{
			...
			public static explicit operator Posit32_3(Posit16_4 x)
		{
			...
			public static explicit operator Posit32_4(Posit16_4 x)
		{
		...
		public Posit16_4  Parse(string number) => new Posit16_4(Double.Parse(number));

		public bool TryParse(string number, out Posit16_4  positResult)
		{
			var returnValue = Double.TryParse(number, out double result);
			positResult = new Posit16_4 (result);
			return returnValue;
		}

		public bool Equals(Posit16_4  other) => (this == other);

		public override bool Equals(object obj) => (obj is Posit16_4  posit) ? Equals(posit) : false;
