...
{
    public readonly struct Posit16E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E1>, IComparable<Posit16E1>
    {
        ...
        public Posit16E1(ushort bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit16E1(bits).PositBits;

        public Posit16E1(Quire q)
        {
        ...
        public  Posit16E1(int value)
        {
            PositBits = value >= 0 ? new Posit16E1((uint)value).PositBits : GetTwosComplement(new Posit16E1((uint)-value).PositBits);
        }

        public Posit16E1(ulong value)
        {
        ...
        public  Posit16E1(long value)
        {
            PositBits = value >= 0 ? new Posit16E1((ulong)value).PositBits : GetTwosComplement(new Posit16E1((ulong)-value).PositBits);
        }

        public  Posit16E1(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit16E1(double doubleBits)
        {
            PositBits = NaNBitMask;
    ...
    #region Methods to handle parts of the Posit 
        ...
        public static Posit16E1 Sqrt(Posit16E1 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit16E1(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit16E1(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (ushort) resultExponentBits,  resultFractionBits), true);
        }
        ...
        public static Posit16E1 FusedSum(Posit16E1[] posits)
        {
            ...
            return new Posit16E1(resultQuire);
        }

        public static Quire FusedSum(Posit16E1[] posits, Quire startingValue)
        {
        ...
        public static Posit16E1 FusedDotProduct(Posit16E1[] positArray1, Posit16E1[] positArray2)
        {
            if (positArray1.Length != positArray2.Length) return new Posit16E1(NaNBitMask, true);
        ...
        public static Posit16E1 FusedMultiplyAdd(Posit16E1 a, Posit16E1 b, Posit16E1 c)
        {
            var positArray1 = new Posit16E1[2];
            var positArray2 = new Posit16E1[2];

            positArray1[0] = a;
            positArray1[1] = new Posit16E1(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit16E1 FusedAddMultiply(Posit16E1 a, Posit16E1 b, Posit16E1 c)
        {
            var positArray1 = new Posit16E1[2];
            var positArray2 = new Posit16E1[2];
        ...
        public static Posit16E1 FusedMultiplyMultiplySubtract(Posit16E1 a, Posit16E1 b, Posit16E1 c, Posit16E1 d)
        {
            var positArray1 = new Posit16E1[2];
            var positArray2 = new Posit16E1[2];
        ...
        public static Posit16E1 operator +(Posit16E1 left, Posit16E1 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E1((ushort)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit16E1((ushort)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit16E1(0, true);
            ...
            return new Posit16E1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, (uint)resultFractionBits), true);
        }

        public static Posit16E1 operator +(Posit16E1 left, int right) => left + new Posit16E1(right);

        public static Posit16E1 operator -(Posit16E1 left, Posit16E1 right) => left + -right;

        public static Posit16E1 operator -(Posit16E1 left, int right) => left - new Posit16E1(right);

        public static Posit16E1 operator -(Posit16E1 x)
        {
            if (x.IsNaN() || x.IsZero()) return new Posit16E1(x.PositBits, true);
            return new Posit16E1(GetTwosComplement(x.PositBits), true);
        }

        public static bool operator ==(Posit16E1 left, Posit16E1 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit16E1 left, Posit16E1 right)
        {
        ...
        public static bool operator !=(Posit16E1 left, Posit16E1 right) => !(left == right);

        public static Posit16E1 operator *(Posit16E1 left, int right) => left * new Posit16E1(right);

        public static Posit16E1 operator *(Posit16E1 left, Posit16E1 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit16E1(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            return new Posit16E1(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit16E1 operator /(Posit16E1 left, Posit16E1 right)
        {
            if (right.IsZero()) return new Posit16E1(NaNBitMask, true);
            if (left.IsZero()) return new Posit16E1(0);
        ...
        public static explicit operator int(Posit16E1 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit16E1 x)
        {
        ...
        public static explicit operator double(Posit16E1 x)
        {
        ...
        public static explicit operator Quire(Posit16E1 x)
        {
        ...
        public static explicit operator Posit8E0(Posit16E1 x)
        {
            ...
            public static explicit operator Posit8E1(Posit16E1 x)
        {
            ...
            public static explicit operator Posit8E2(Posit16E1 x)
        {
            ...
            public static explicit operator Posit8E3(Posit16E1 x)
        {
            ...
            public static explicit operator Posit8E4(Posit16E1 x)
        {
            ...
            public static explicit operator Posit16E0(Posit16E1 x)
        {
            ...
            public static explicit operator Posit16E2(Posit16E1 x)
        {
            ...
            public static explicit operator Posit16E3(Posit16E1 x)
        {
            ...
            public static explicit operator Posit16E4(Posit16E1 x)
        {
            ...
            public static explicit operator Posit32E0(Posit16E1 x)
        {
            ...
            public static explicit operator Posit32E1(Posit16E1 x)
        {
            ...
            public static explicit operator Posit32E2(Posit16E1 x)
        {
            ...
            public static explicit operator Posit32E3(Posit16E1 x)
        {
            ...
            public static explicit operator Posit32E4(Posit16E1 x)
        {
        ...
        public Posit16E1  Parse(string number) => new Posit16E1(Double.Parse(number));

        public bool TryParse(string number, out Posit16E1  positResult)
        {
            var returnValue = Double.TryParse(number, out double result);
            positResult = new Posit16E1 (result);
            return returnValue;
        }

        public bool Equals(Posit16E1  other) => (this == other);

        public override bool Equals(object obj) => (obj is Posit16E1  posit) ? Equals(posit) : false;
