...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit16E1 : IComparable, IConvertible, IFormattable, IEquatable<Posit16E1>, IComparable<Posit16E1>
    {
        ...
        public static Posit16E1 operator +(Posit16E1 left, Posit16E1 right)
        {
            ...
            var leftAbsoluteValue = new Posit16E1(
            ...
            var rightAbsoluteValue = new Posit16E1(
            ...
            {
                return new Posit16E1(0, fromBitMask: true);
            }
        ...
        public static Posit16E1 operator -(Posit16E1 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit16E1(x.PositBits, fromBitMask: true)
                : new Posit16E1(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit16E1 operator /(Posit16E1 left, Posit16E1 right)
        {
            if (right.IsZero()) return new Posit16E1(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit16E1 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit16E1 obj)
        {
        ...
        public Posit16E1 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit16E1 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit16E1 posit && Equals(posit);
