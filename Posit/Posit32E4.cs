...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E4>, IComparable<Posit32E4>
    {
        ...
        public static Posit32E4 Sqrt(Posit32E4 number)
        {
            ...
            if (!number.IsPositive()) return new Posit32E4(NaNBitMask, true);
            ...
            while (estimateMaskingBit != 0)
            {
                ...
                return new Posit32E4(AssemblePositBitsWithRounding(false, resultRegimeKValue,  (uint) resultExponentBits,  resultFractionBits), true);
        }
        ...
        {
            if (positArray1.Length != positArray2.Length) return new Posit32E4(NaNBitMask, true);
        ...
        public static Posit32E4 operator +(Posit32E4 left, Posit32E4 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E4((uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit), true);

            var rightSignBit = right.PositBits >> Size - 1;
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit32E4((uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit), true);
            ...
            if (resultFractionBits == 0) return new Posit32E4(0, true);
            ...
            return new Posit32E4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, (ulong)resultFractionBits), true);
        }
        ...
        {
            if (x.IsNaN() || x.IsZero()) return new Posit32E4(x.PositBits, true);
            return new Posit32E4(GetTwosComplement(x.PositBits), true);
        }
        ...
        public static Posit32E4 operator *(Posit32E4 left, Posit32E4 right)
        {
            ...
            return new Posit32E4(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (uint) resultExponentBits, longResultFractionBits), true);
        }
        ...
        public static Posit32E4 operator /(Posit32E4 left, Posit32E4 right)
        {
            if (right.IsZero()) return new Posit32E4(NaNBitMask, true);
