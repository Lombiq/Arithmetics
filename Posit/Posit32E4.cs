...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit32E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E4>, IComparable<Posit32E4>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit32E4((uint)value).PositBits : GetTwosComplement(new Posit32E4((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit32E4((ulong)value).PositBits : GetTwosComplement(new Posit32E4((ulong)-value).PositBits);
        }
