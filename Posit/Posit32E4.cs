...
{
    public readonly struct Posit32E4 : IComparable, IConvertible, IFormattable, IEquatable<Posit32E4>, IComparable<Posit32E4>
    {
        ...
        public Posit32E4(uint bits, bool fromBitMask) =>
            PositBits = fromBitMask ? bits : new Posit32E4(bits).PositBits;

        public Posit32E4(Quire q)
        {
        ...
        public Posit32E4(int value) =>
            PositBits = value >= 0
                ? new Posit32E4((uint)value).PositBits
                : GetTwosComplement(new Posit32E4((uint)-value).PositBits);

        public Posit32E4(ulong value)
        {
            if (value == 0)
            {
                PositBits = (uint)value;
        ...
        public Posit32E4(long value) =>
            PositBits = value >= 0
                ? new Posit32E4((ulong)value).PositBits
                : GetTwosComplement(new Posit32E4((ulong)-value).PositBits);

        public Posit32E4(float floatBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit32E4(double doubleBits)
        {
            PositBits = NaNBitMask;
        ...
        public Posit32E4(bool sign, short scaleFactor, uint fraction)
        {
            var resultRegimeKValue = scaleFactor / (1 << MaximumExponentSize);
        ...
        public static uint EncodeRegimeBits(int regimeKValue)
        {
            ...
            {
                regimeBits = (uint)(FirstRegimeBitBitMask >> -regimeKValue);
            }

            return regimeBits;
        }

        public static uint AssemblePositBitsWithRounding(
            bool signBit,
            int regimeKValue,
            uint exponentBits,
            uint fractionBits)
        {
            ...
            wholePosit += exponentShiftedLeftBy >= 0
                ? (uint)(exponentBits << exponentShiftedLeftBy)
                : (uint)(exponentBits >> -exponentShiftedLeftBy);
            ...
            wholePosit += fractionShiftedLeftBy >= 0
                ? (uint)(fractionBits << fractionShiftedLeftBy)
                : (uint)(fractionBits >> -fractionShiftedLeftBy);
            ...
            ulong fractionBits)
        {
            ...
            if (exponentShiftedLeftBy < 0)
            {
                ...
                if ((uint)exponentBits < SignBitMask)
                {
                    // The first non-fitting exponent bit is zero, so we dont round up.
                    return signBit ? GetTwosComplement(wholePosit) : wholePosit;
                }

                if (((uint)exponentBits == SignBitMask) && (fractionBits == 0))
                {
                    wholePosit += (uint)(wholePosit & 1);
                }
                else
        ...
        public uint GetExponentValueWithoutSignCheck() =>
            (uint)((uint)((PositBits >> (int)FractionSizeWithoutSignCheck())
                << (Size - ExponentSize()))
                >> (Size - MaximumExponentSize));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint GetExponentValueWithoutSignCheck(uint fractionSize) =>
            (uint)((uint)((PositBits >> (int)fractionSize)
                << (Size - ExponentSize()))
                >> (Size - MaximumExponentSize));
        ...
        public static Quire MultiplyIntoQuire(Posit32E4 left, Posit32E4 right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Posit32E4 Abs(Posit32E4 input)
        {
            var signBit = input.PositBits >> (Size - 1);
            var maskOfSignBits = 0 - signBit;

            return new Posit32E4((uint)((input.PositBits ^ maskOfSignBits) + signBit), fromBitMask: true);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint GetTwosComplement(uint bits) =>
            (uint)(~bits + 1);
        ...
        public static Posit32E4 Sqrt(Posit32E4 number)
        {
            if (number.IsNaN() || number.IsZero()) return number;
            if (!number.IsPositive()) return new Posit32E4(NaNBitMask, fromBitMask: true);
        ...
        public static Posit32E4 FusedSum(Posit32E4[] posits)
        {
            ...
            return new Posit32E4(resultQuire);
        }

        public static Quire FusedSum(Posit32E4[] posits, Quire startingValue)
        {
        ...
        public static Posit32E4 FusedDotProduct(Posit32E4[] positArray1, Posit32E4[] positArray2)
        {
            if (positArray1.Length != positArray2.Length)
            {
                return new Posit32E4(NaNBitMask, fromBitMask: true);
            }
        ...
        public static Posit32E4 FusedMultiplyAdd(Posit32E4 a, Posit32E4 b, Posit32E4 c)
        {
            var positArray1 = new Posit32E4[2];
            var positArray2 = new Posit32E4[2];

            positArray1[0] = a;
            positArray1[1] = new Posit32E4(1);
            positArray2[0] = b;
            positArray2[1] = c;
        ...
        public static Posit32E4 FusedAddMultiply(Posit32E4 a, Posit32E4 b, Posit32E4 c)
        {
            var positArray1 = new Posit32E4[2];
            var positArray2 = new Posit32E4[2];
        ...
        public static Posit32E4 FusedMultiplyMultiplySubtract(Posit32E4 a, Posit32E4 b, Posit32E4 c, Posit32E4 d)
        {
            var positArray1 = new Posit32E4[2];
            var positArray2 = new Posit32E4[2];
        ...
        public static Posit32E4 operator +(Posit32E4 left, Posit32E4 right)
        {
            ...
            var leftAbsoluteValue = new Posit32E4(
                (uint)((left.PositBits ^ leftMaskOfSignBits) + leftSignBit),
                fromBitMask: true);

            var rightSignBit = right.PositBits >> (Size - 1);
            var rightMaskOfSignBits = 0 - rightSignBit;
            var rightAbsoluteValue = new Posit32E4(
                (uint)((right.PositBits ^ rightMaskOfSignBits) + rightSignBit),
                fromBitMask: true);
            ...
            if (scaleFactorDifference == 0)
            {
                ...
                else
                {
                    resultFractionBits += leftFraction >= rightFraction
                        ? (ulong)((ulong)leftFraction - rightFraction)
                        : (ulong)((ulong)rightFraction - leftFraction);
                }
            ...
            else
            {
                ...
                if (signBitsMatch)
                {
                    resultFractionBits += biggerPositMovedToLeft + scaleFactorDifference + fractionSizeDifference >= 0
                        ? (ulong)((ulong)leftFraction << (biggerPositMovedToLeft + scaleFactorDifference + fractionSizeDifference))
                        : (ulong)((ulong)leftFraction >> -(biggerPositMovedToLeft + scaleFactorDifference + fractionSizeDifference));
            ...
            {
                return new Posit32E4(0, fromBitMask: true);
            }
            ...
            return new Posit32E4(
                AssemblePositBitsWithRounding(
                    ...
                    resultRegimeKValue,
                    (uint)resultExponentBits,
                    (ulong)resultFractionBits),
                fromBitMask: true);
        }

        public static Posit32E4 operator +(Posit32E4 left, int right) => left + new Posit32E4(right);

        public static Posit32E4 operator -(Posit32E4 left, Posit32E4 right) => left + -right;

        public static Posit32E4 operator -(Posit32E4 left, int right) => left - new Posit32E4(right);

        public static Posit32E4 operator -(Posit32E4 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit32E4(x.PositBits, fromBitMask: true)
                : new Posit32E4(GetTwosComplement(x.PositBits), fromBitMask: true);

        public static bool operator ==(Posit32E4 left, Posit32E4 right) => left.PositBits == right.PositBits;

        public static bool operator >(Posit32E4 left, Posit32E4 right)
        {
        ...
        public static bool operator !=(Posit32E4 left, Posit32E4 right) => !(left == right);

        public static Posit32E4 operator *(Posit32E4 left, int right) => left * new Posit32E4(right);

        public static Posit32E4 operator *(Posit32E4 left, Posit32E4 right)
        {
            if (left.IsZero() || right.IsZero()) return new Posit32E4(0);
            var leftIsPositive = left.IsPositive();
            var rightIsPositive = right.IsPositive();
            var resultSignBit = leftIsPositive != rightIsPositive;
            ...
            ulong longResultFractionBits =
                (ulong)((ulong)left.FractionWithHiddenBitWithoutSignCheck() * right.FractionWithHiddenBitWithoutSignCheck());
            var fractionSizeChange = PositHelper.GetMostSignificantOnePosition(longResultFractionBits) - (leftFractionSize + rightFractionSize + 1);
        ...
        public static Posit32E4 operator /(Posit32E4 left, Posit32E4 right)
        {
            if (right.IsZero()) return new Posit32E4(NaNBitMask, fromBitMask: true);
            if (left.IsZero()) return new Posit32E4(0);
            ...
            var alignedLeftFraction = (ulong)((ulong)left.FractionWithHiddenBitWithoutSignCheck()
                << (int)((2 * Size) - 1 - leftFractionSize));
            var alignedRightFraction = (uint)(right.FractionWithHiddenBitWithoutSignCheck()
        ...
        public static explicit operator int(Posit32E4 x)
        {
            uint result;
        ...
        public static explicit operator float(Posit32E4 x)
        {
        ...
        public static explicit operator double(Posit32E4 x)
        {
        ...
        public static explicit operator Quire(Posit32E4 x)
        {
        ...
        public static explicit operator Posit8E0(Posit32E4 x)
        {
        ...
        public static explicit operator Posit8E1(Posit32E4 x)
        {
        ...
        public static explicit operator Posit8E2(Posit32E4 x)
        {
        ...
        public static explicit operator Posit8E3(Posit32E4 x)
        {
        ...
        public static explicit operator Posit8E4(Posit32E4 x)
        {
        ...
        public static explicit operator Posit16E0(Posit32E4 x)
        {
        ...
        public static explicit operator Posit16E1(Posit32E4 x)
        {
        ...
        public static explicit operator Posit16E2(Posit32E4 x)
        {
        ...
        public static explicit operator Posit16E3(Posit32E4 x)
        {
        ...
        public static explicit operator Posit16E4(Posit32E4 x)
        {
        ...
        public static explicit operator Posit32E0(Posit32E4 x)
        {
        ...
        public static explicit operator Posit32E1(Posit32E4 x)
        {
        ...
        public static explicit operator Posit32E2(Posit32E4 x)
        {
        ...
        public static explicit operator Posit32E3(Posit32E4 x)
        {
        ...
        {
            null => 1,
            Posit32E4 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit32E4 obj)
        {
        ...
        public Posit32E4 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit32E4 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));

        public bool TryParse(string number, out Posit32E4 positResult)
        {
            var returnValue = double.TryParse(number, out double result);
            positResult = new Posit32E4(result);
            return returnValue;
        }

        public bool Equals(Posit32E4 other) => this == other;

        public override bool Equals(object obj) => obj is Posit32E4 posit && Equals(posit);
