...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E2 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E2>, IComparable<Posit8E2>
    {
        ...
        {
            PositBits = value >= 0 ? new Posit8E2((uint)value).PositBits : GetTwosComplement(new Posit8E2((uint)-value).PositBits);
        }
        ...
        {
            PositBits = value >= 0 ? new Posit8E2((ulong)value).PositBits : GetTwosComplement(new Posit8E2((ulong)-value).PositBits);
        }
        ...
        public static byte  AssemblePositBitsWithRounding(bool signBit, int regimeKValue,byte exponentBits ,  byte fractionBits)
        {
            ...
            if (exponentShiftedLeftBy < 0)
            {
                ...
                if ((exponentBits == SignBitMask) && fractionBits == 0) wholePosit += (byte)(wholePosit & 1);
                else wholePosit += 1;
