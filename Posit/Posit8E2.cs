...
namespace Lombiq.Arithmetics
{
    public readonly struct Posit8E2 : IComparable, IConvertible, IFormattable, IEquatable<Posit8E2>, IComparable<Posit8E2>
    {
        ...
        public static Posit8E2 operator +(Posit8E2 left, Posit8E2 right)
        {
            ...
            var leftAbsoluteValue = new Posit8E2(
            ...
            var rightAbsoluteValue = new Posit8E2(
            ...
            {
                return new Posit8E2(0, fromBitMask: true);
            }
        ...
        public static Posit8E2 operator -(Posit8E2 x) =>
            x.IsNaN() || x.IsZero()
                ? new Posit8E2(x.PositBits, fromBitMask: true)
                : new Posit8E2(GetTwosComplement(x.PositBits), fromBitMask: true);
        ...
        public static Posit8E2 operator /(Posit8E2 left, Posit8E2 right)
        {
            if (right.IsZero()) return new Posit8E2(NaNBitMask, fromBitMask: true);
        ...
        {
            null => 1,
            Posit8E2 posit => CompareTo(posit),
            _ => throw new ArgumentException("Argument must be an other posit."),
        };

        public int CompareTo(Posit8E2 obj)
        {
        ...
        public Posit8E2 Parse(string number) => Parse(number, CultureInfo.InvariantCulture);

        public Posit8E2 Parse(string number, IFormatProvider provider) => new(double.Parse(number, provider));
        ...
        public override bool Equals(object obj) => obj is Posit8E2 posit && Equals(posit);
