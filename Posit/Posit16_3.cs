...
namespace Lombiq.Arithmetics
{
	public readonly struct Posit16_3 : IComparable, IConvertible, IFormattable, IEquatable<Posit16_3>, IComparable<Posit16_3>
	{
		...
		public static Posit16_3 Sqrt(Posit16_3 number)
		{
			...
			return new Posit16_3(AssemblePositBitsWithRounding(false, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_3 operator +(Posit16_3 left, Posit16_3 right)
		{
			...
			return new Posit16_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, resultExponentBits, resultFractionBits), true);
		}
		...
		public static Posit16_3 operator /(Posit16_3 left, Posit16_3 right)
		{
			...
			return new Posit16_3(AssemblePositBitsWithRounding(resultSignBit, resultRegimeKValue, (ushort)resultExponentBits, resultFractionBits), true);
		}
