...
namespace Lombiq.Arithmetics.Tests
{
    ...
    public class UnumTests
    {
        ...
        public void WarlpiriUnumValuesAndCalculationsAreCorrect()
        {
            ...
            var unumNegative0 = new Unum(_warlpiriEnvironment, new BitMask(new ulong[] { 8 }, _warlpiriEnvironment.Size));
        ...
        public void UnumIsCorrectlyConstructedFromUintArray()
        {
            ...
            var unum0 = new Unum(_environment_4_8, new ulong[] { 0 });
            Assert.AreEqual(unum0.IsZero(), true);

            var unumMinus1 = new Unum(_environment_4_8, new ulong[] { 1 }, true);
            var bitMaskMinus1 = new BitMask(new ulong[] { 0x2000, 0, 0, 0, 0, 0, 0, 0, 0x20000000 }, _environment_4_8.Size);
            Assert.AreEqual(unumMinus1.UnumBits, bitMaskMinus1);

            var unum10 = new Unum(_environment_2_2, new ulong[] { 10 });
            var bitMask10 = new BitMask(new ulong[] { 0x329 }, _environment_2_2.Size);
            Assert.AreEqual(unum10.UnumBits, bitMask10);

            var unum500000 = new Unum(_environment_4_8, new ulong[] { 500000 }); // 0xC7A1250C9 
            var bitMask500000 = new BitMask(new ulong[] { 0xC7A1250C }, _environment_4_8.Size);
            Assert.AreEqual(unum500000.UnumBits, bitMask500000);

            var unumBig = new Unum(_environment_4_8, new ulong[] { 594967295 });
            var bitMaskBig = new BitMask(new ulong[] { 0xCF5FE51C, 0xF06E }, _environment_4_8.Size);
            Assert.AreEqual(unumBig.UnumBits, bitMaskBig);

            var minValue = new ulong[8];
            for (var i = 0; i < 8; i++) minValue[i] = uint.MaxValue;
            minValue[7] >>= 1;
            var unumMin = new Unum(_environment_4_8, minValue, true);  // This is negative.
            var bitMaskMinValue = new BitMask(new ulong[]
            {
            ...
            var maxValue = new ulong[8];
            for (int i = 0; i < 8; i++) maxValue[i] = uint.MaxValue;
            maxValue[7] >>= 1;

            var bitMaskMaxValue = new BitMask(new ulong[]
            {
                0xFFFFE8FD , 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
            ...
            var maxBitMask_2_2 = new BitMask(new ulong[] { 0xFEE }, _environment_2_2.Size);
            Assert.AreEqual(maxValue_2_2.UnumBits, maxBitMask_2_2);

            var minValue_2_2 = new Unum(_environment_2_2, -480);
            var bitMaskMinValue_2_2 = new BitMask(new ulong[] { 0x2FEE }, _environment_2_2.Size);
            ...
            var maxBitMask_2_3 = new BitMask(new ulong[] { 0x1FFDE }, _environment_2_3.Size);
            Assert.AreEqual(maxValue_2_3.UnumBits, maxBitMask_2_3);

            var minValue_2_3 = new Unum(_environment_2_3, -510);
            var bitMaskMinValue_2_3 = new BitMask(new ulong[] { 0x5FFDE }, _environment_2_3.Size);
            ...
            var maxBitMask_2_4 = new BitMask(new ulong[] { 0x7FFB7 }, _environment_2_4.Size);
            Assert.AreEqual(maxValue_2_4.UnumBits, maxBitMask_2_4);

            var minValue_2_4 = new Unum(_environment_2_4, -511);
            var bitMaskMinValue_2_4 = new BitMask(new ulong[] { 0x807FFB7 }, _environment_2_4.Size);
        ...
        {
            var unumZero = new Unum(_environment_4_8, new ulong[] { 0 });
            Assert.AreEqual(unumZero.FractionToUintArray(), new ulong[] { 0, 0, 0, 0, 0, 0, 0, 0, 0 });

            var unum1 = new Unum(_environment_4_8, new ulong[] { 1 });
            Assert.AreEqual(unum1.FractionToUintArray(), new ulong[] { 1, 0, 0, 0, 0, 0, 0, 0, 0 });

            var unum500000 = new Unum(_environment_4_8, new ulong[] { 500000 }); //0xC7A1250C
            Assert.AreEqual(unum500000.FractionToUintArray(), new ulong[] { 500000, 0, 0, 0, 0, 0, 0, 0, 0 });

            var unumBig = new Unum(_environment_4_8, new ulong[] { 594967295 });
            Assert.AreEqual(unumBig.FractionToUintArray(), new ulong[] { 594967295, 0, 0, 0, 0, 0, 0, 0, 0 });
            ...
            maxValue[7] >>= 1;
            var unumMax = new Unum(_environment_4_8, maxValue);
            Assert.AreEqual(unumMax.FractionToUintArray(), new ulong[]
        ...
        //    var bitMask_1 = new BitMask(new ulong[] { 0x3F22 }, _metaData_3_4.Size);
        //    var bitMask_2 = new BitMask(new ulong[] { 0x6A2309EF }, _metaData_3_4.Size);
        //    var bitMask_5 = new BitMask(new ulong[] { 0x1A21 }, _metaData_3_5.Size);
        //    var bitMask_3 = new BitMask(new ulong[] { 0x660 }, _metaData_3_4.Size);
        //    var bitMask_4 = new BitMask(new ulong[] { 0xA40 }, _metaData_3_5.Size);
        ...
        public void UnumIsCorrectlyConstructedFromUInt()
        {
            ...
            var bitMask2 = new BitMask(new ulong[] { 0x200 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask2, unum2.UnumBits);

            var unum4 = new Unum(_environment_3_4, (uint)4);
            var bitMask4 = new BitMask(new ulong[] { 0x610 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask4, unum4.UnumBits);

            var unum8 = new Unum(_environment_3_4, (uint)8);
            var bitMask8 = new BitMask(new ulong[] { 0xC20 }, _environment_3_4.Size);
            ...
            var bitMask13 = new BitMask(new ulong[] { 0x3522 }, _environment_3_4.Size);
        ...
        public void IsExactIsCorrect()
        {
            ...
            var bitMask_3_2_uncertain = new BitMask(new ulong[] { 0x20 }, 19);
            ...
            var bitMask_3_4_uncertain = new BitMask(new ulong[] { 0x80, 0 }, 33);
        ...
        public void FractionMaskIsCorrect()
        {
            ...
            var bitMask_3_2_allOne = new BitMask(19, true);
            var unum_3_2_allOne = new Unum(_environment_3_2, bitMask_3_2_allOne);
            var bitMask_3_2_FractionMask = new BitMask(new ulong[] { 0x3C0 }, 19);
            Assert.AreEqual(bitMask_3_2_FractionMask, unum_3_2_allOne.FractionMask());

            // 0  0000 0000  1111 1111 1111 1111  0000 0000
            var bitMask_3_4_allOne = new BitMask(33, true);
            var unum_3_4_allOne = new Unum(_environment_3_4, bitMask_3_4_allOne);
            var bitMask_3_4_FractionMask = new BitMask(new ulong[] { 0xFFFF00 }, 33);
        ...
        public void ExponentMaskIsCorrect()
        {
            ...
            var bitMask_3_2_allOne = new BitMask(19, true);
            var unum_3_2_allOne = new Unum(_environment_3_2, bitMask_3_2_allOne);
            var bitMask_3_2_ExponentMask = new BitMask(new ulong[] { 0x3FC00 }, 19);
            Assert.AreEqual(bitMask_3_2_ExponentMask, unum_3_2_allOne.ExponentMask());

            // 0  1111 1111  0000 0000 0000 0000  0 000 0000
            var bitMask_3_4_allOne = new BitMask(33, true);
            var unum_3_4_allOne = new Unum(_environment_3_4, bitMask_3_4_allOne);
            var bitMask_3_4_ExponentMask = new BitMask(new ulong[] { 0xFF000000 }, 33);
        ...
        {
            var bitMask1 = new BitMask(new ulong[] { 0xE40 }, 33);
        ...
        public void FractionWithHiddenBitIsCorrect()
        {
            var bitMask1 = new BitMask(new ulong[] { 0xE40 }, 33);
            var unum1 = new Unum(_environment_3_4, bitMask1);
            Assert.AreEqual(new BitMask(new ulong[] { 2 }, 33), unum1.FractionWithHiddenBit());

            var bitMask2 = new BitMask(new ulong[] { 0x3F22 }, 33);
            var unum2 = new Unum(_environment_3_4, bitMask2);
            Assert.AreEqual(new BitMask(new ulong[] { 0xF }, 33), unum2.FractionWithHiddenBit());

            var bitMask3 = new BitMask(new ulong[] { 0x7E012B }, 33);
            var unum3 = new Unum(_environment_3_4, bitMask3);
            Assert.AreEqual(new BitMask(new ulong[] { 0x1E01 }, 33), unum3.FractionWithHiddenBit());
        }
        ...
        public void AddExactUnumsIsCorrect()
        {
            ...
            var bitMaskSum = new BitMask(new ulong[] { 0x7E012B }, 33);
            ...
            var bitMask4 = new BitMask(new ulong[] { 0x18F400CF }, 33); // 1000.0078125
            var unum1000 = new Unum(_environment_3_4, 1000);
        ...
        {
            var bitMask1 = new BitMask(new ulong[] { 0x7E012B }, 33); // 30.00390625
            var bitMask2 = new BitMask(new ulong[] { 0xE40 }, 33);    // 0.00390625
            var bitMask3 = new BitMask(new ulong[] { 0x3F22 }, 33);   // 30
        ...
        {
            var unum0 = new Unum(_environment_3_4, 0);
            var bitMask0 = new BitMask(new ulong[] { 0 }, 33);
            Assert.AreEqual(unum0.UnumBits, bitMask0);

            var unum1 = new Unum(_environment_3_4, 1);
            Assert.AreEqual(unum1.UnumBits, new BitMask(new ulong[] { 0x100 }, 33));

            var unum2 = new Unum(_environment_3_4, 2);
            Assert.AreEqual(unum2.UnumBits, new BitMask(new ulong[] { 0x200 }, 33));

            var unum30 = new Unum(_environment_3_4, 30);
            var bitMask30 = new BitMask(new ulong[] { 0x3F22 }, 33);
            Assert.AreEqual(unum30.UnumBits, bitMask30);

            var unum1000 = new Unum(_environment_3_4, 1000);
            var bitMask1000 = new BitMask(new ulong[] { 0x63D45 }, 33);
            Assert.AreEqual(unum1000.UnumBits, bitMask1000);

            var unum5000 = new Unum(_environment_3_4, 5000);
            var bitMask5000 = new BitMask(new ulong[] { 0x367148 }, 33);
            Assert.AreEqual(unum5000.UnumBits, bitMask5000);

            var bitMask6000 = new BitMask(new ulong[] { 0x1B7747 }, 33);
            var unum6000 = new Unum(_environment_3_4, 6000);
            Assert.AreEqual(unum6000.UnumBits, bitMask6000);

            var unumNegative30 = new Unum(_environment_3_4, -30);
            var bitMaskNegative30 = new BitMask(new ulong[] { 0x3F22, 1 }, 33);
            Assert.AreEqual(unumNegative30.UnumBits, bitMaskNegative30);

            var unumNegative1000 = new Unum(_environment_3_4, -1000);
            var bitMaskNegative1000 = new BitMask(new ulong[] { 0x63D45, 1 }, 33);
        ...
        //    var bitMask_1 = new BitMask(new ulong[] { 0x3F22 }, 33);
        //    var bitMask_2 = new BitMask(new ulong[] { 0x6A2309EF }, 33);
