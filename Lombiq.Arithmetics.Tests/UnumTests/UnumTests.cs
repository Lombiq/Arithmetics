...
namespace Lombiq.Arithmetics.Tests
{
    public class UnumTests
    {
        ...
        public void UnumIsCorrectlyConstructedFromUintArray()
        {
            ...
            var bitMaskMinus1 = new BitMask(new uint[] { 0x_2000, 0, 0, 0, 0, 0, 0, 0, 0x_2000_0000 }, _environment_4_8.Size);
            Assert.AreEqual(unumMinus1.UnumBits, bitMaskMinus1);

            var unum10 = new Unum(_environment_2_2, new uint[] { 10 });
            var bitMask10 = new BitMask(new uint[] { 0x_329 }, _environment_2_2.Size);
            Assert.AreEqual(unum10.UnumBits, bitMask10);

            var unum500000 = new Unum(_environment_4_8, new uint[] { 500_000 }); // 0xC7A1250C9
            var bitMask500000 = new BitMask(new uint[] { 0x_C7A1_250C }, _environment_4_8.Size);
            Assert.AreEqual(unum500000.UnumBits, bitMask500000);

            var unumBig = new Unum(_environment_4_8, new uint[] { 594_967_295 });
            var bitMaskBig = new BitMask(new uint[] { 0x_CF5F_E51C, 0x_F06E }, _environment_4_8.Size);
            ...
            {
                0x_FFFF_E8FD , 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF,
                0x_FFFF_FFFF , 0x_FFFF_FFFF,  0x_F_EFFF,
            ...
            var maxBitMask_2_2 = new BitMask(new uint[] { 0x_FEE }, _environment_2_2.Size);
            Assert.AreEqual(maxValue_2_2.UnumBits, maxBitMask_2_2);

            var minValue_2_2 = new Unum(_environment_2_2, -480);
            var bitMaskMinValue_2_2 = new BitMask(new uint[] { 0x_2FEE }, _environment_2_2.Size);
            ...
            var maxBitMask_2_3 = new BitMask(new uint[] { 0x_1_FFDE }, _environment_2_3.Size);
            Assert.AreEqual(maxValue_2_3.UnumBits, maxBitMask_2_3);

            var minValue_2_3 = new Unum(_environment_2_3, -510);
            var bitMaskMinValue_2_3 = new BitMask(new uint[] { 0x_5_FFDE }, _environment_2_3.Size);
            ...
            var maxBitMask_2_4 = new BitMask(new uint[] { 0x_7_FFB7 }, _environment_2_4.Size);
            Assert.AreEqual(maxValue_2_4.UnumBits, maxBitMask_2_4);

            var minValue_2_4 = new Unum(_environment_2_4, -511);
            var bitMaskMinValue_2_4 = new BitMask(new uint[] { 0x_807_FFB7 }, _environment_2_4.Size);
        ...
        public void FractionToUintArrayIsCorrect()
        {
            ...
            var unum500000 = new Unum(_environment_4_8, new uint[] { 500_000 }); // 0xC7A1250C
            ...
            Assert.AreEqual(unumMax.FractionToUintArray(), new uint[]
                { 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_FFFF_FFFF, 0x_7FFF_FFFF, 0 });
        }

        // [Fact]
        // public void UnumIsCorrectlyConstructedFromFloat()
        // {
        //    var first = new Unum(_metaData_3_4, 30.0F);
        //    var second = new Unum(_metaData_3_4, 9999999999999F);
        //    var third = new Unum(_metaData_3_4, 1.5F);
        //    var five = new Unum(_metaData_3_5, 5F);
        ...
        public void UnumIsCorrectlyConstructedFromInt()
        {
            ...
            var bitMask1 = new BitMask(new uint[] { 0x_100 }, _environment_3_4.Size);
            Assert.AreEqual(unum1.UnumBits, bitMask1);

            var unum30 = new Unum(_environment_3_4, 30);
            var bitMask30 = new BitMask(new uint[] { 0x_3F22 }, _environment_3_4.Size);
            Assert.AreEqual(unum30.UnumBits, bitMask30);

            var unum1000 = new Unum(_environment_3_4, 1_000);
            var bitMask1000 = new BitMask(new uint[] { 0x_6_3D45 }, _environment_3_4.Size);
            Assert.AreEqual(unum1000.UnumBits, bitMask1000);

            var unum5000 = new Unum(_environment_3_4, 5_000);
            var bitMask5000 = new BitMask(new uint[] { 0x_36_7148 }, _environment_3_4.Size);
            Assert.AreEqual(unum5000.UnumBits, bitMask5000);

            var unum6000 = new Unum(_environment_3_4, 6_000);
            var bitMask6000 = new BitMask(new uint[] { 0x_1B_7747 }, _environment_3_4.Size);
            Assert.AreEqual(unum6000.UnumBits, bitMask6000);

            var unumNegative30 = new Unum(_environment_3_4, -30);
            var bitMaskMinus30 = new BitMask(new uint[] { 0x_3F22, 1 }, _environment_3_4.Size);
            Assert.AreEqual(unumNegative30.UnumBits, bitMaskMinus30);

            var unumNegative1000 = new Unum(_environment_3_4, -1_000);
            var bitMaskMinus1000 = new BitMask(new uint[] { 0x_6_3D45, 1 }, _environment_3_4.Size);
        ...
        public void UnumIsCorrectlyConstructedFromUInt()
        {
            ...
            var bitMask2 = new BitMask(new uint[] { 0x_200 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask2, unum2.UnumBits);

            var unum4 = new Unum(_environment_3_4, 4U);
            var bitMask4 = new BitMask(new uint[] { 0x_610 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask4, unum4.UnumBits);

            var unum8 = new Unum(_environment_3_4, 8U);
            var bitMask8 = new BitMask(new uint[] { 0x_C20 }, _environment_3_4.Size);
            ...
            var bitMask13 = new BitMask(new uint[] { 0x_3522 }, _environment_3_4.Size);
            ...
            var unum1000 = new Unum(_environment_3_4, 1_000U);
            var bitMask1000 = new BitMask(new uint[] { 0x_6_3D45 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask1000, unum1000.UnumBits);

            var unum5000 = new Unum(_environment_3_4, 5_000U);
            var bitMask5000 = new BitMask(new uint[] { 0x_36_7148 }, _environment_3_4.Size);
            Assert.AreEqual(bitMask5000, unum5000.UnumBits);

            var unum6000 = new Unum(_environment_3_4, 6_000U);
            var bitMask6000 = new BitMask(new uint[] { 0x_1B_7747 }, _environment_3_4.Size);
        ...
        public void IsExactIsCorrect()
        {
            ...
            var bitMask_3_2_uncertain = new BitMask(new uint[] { 0x_20 }, 19);
            ...
            var bitMask_3_4_uncertain = new BitMask(new uint[] { 0x_80, 0 }, 33);
        ...
        public void FractionMaskIsCorrect()
        {
            ...
            var bitMask_3_2_allOne = new BitMask(19, true);
            var unum_3_2_allOne = new Unum(_environment_3_2, bitMask_3_2_allOne);
            var bitMask_3_2_FractionMask = new BitMask(new uint[] { 0x_3C0 }, 19);
            Assert.AreEqual(bitMask_3_2_FractionMask, unum_3_2_allOne.FractionMask());

            // 0  0000 0000  1111 1111 1111 1111  0000 0000
            var bitMask_3_4_allOne = new BitMask(33, true);
            var unum_3_4_allOne = new Unum(_environment_3_4, bitMask_3_4_allOne);
            var bitMask_3_4_FractionMask = new BitMask(new uint[] { 0x_FF_FF00 }, 33);
        ...
        public void ExponentMaskIsCorrect()
        {
            ...
            var bitMask_3_2_allOne = new BitMask(19, true);
            var unum_3_2_allOne = new Unum(_environment_3_2, bitMask_3_2_allOne);
            var bitMask_3_2_ExponentMask = new BitMask(new uint[] { 0x_3_FC00 }, 19);
            Assert.AreEqual(bitMask_3_2_ExponentMask, unum_3_2_allOne.ExponentMask());

            // 0  1111 1111  0000 0000 0000 0000  0 000 0000
            var bitMask_3_4_allOne = new BitMask(33, true);
            var unum_3_4_allOne = new Unum(_environment_3_4, bitMask_3_4_allOne);
            var bitMask_3_4_ExponentMask = new BitMask(new uint[] { 0x_FF00_0000 }, 33);
        ...
        public void FractionWithHiddenBitIsCorrect()
        {
            ...
            Assert.AreEqual(new BitMask(new uint[] { 0x_F }, 33), unum2.FractionWithHiddenBit());

            var bitMask3 = new BitMask(new uint[] { 0x_7E_012B }, 33);
        ...
        public void AddExactUnumsIsCorrect()
        {
            ...
            var bitMaskSum = new BitMask(new uint[] { 0x_7E_012B }, 33);
        ...
        public void AdditionIsCorrectForIntegers()
        {
            ...
            for (int i = 1; i <= count; i++) result += new Unum(_environment_3_5, i * 1_000);
            for (int i = 1; i <= count; i++) result -= new Unum(_environment_3_5, i * 1_000);
        ...
        //    var res1 = new Unum(_metaData_3_5, 13.0F);
        //    var res2 = new Unum(_metaData_3_5, 4.0F);
        //    res3 = res1 + res2;
        //    res3 -= res2;
        //    res3 -= res1;
        ...
        {
            var bitMask1 = new BitMask(new uint[] { 0x_7E_012B }, 33); // 30.00390625
            var bitMask2 = new BitMask(new uint[] { 0x_E40 }, 33);    // 0.00390625
        ...
        public void IntToUnumIsCorrect()
        {
            ...
            var unum1000 = new Unum(_environment_3_4, 1_000);
            var bitMask1000 = new BitMask(new uint[] { 0x_6_3D45 }, 33);
            Assert.AreEqual(unum1000.UnumBits, bitMask1000);

            var unum5000 = new Unum(_environment_3_4, 5_000);
            var bitMask5000 = new BitMask(new uint[] { 0x_36_7148 }, 33);
            Assert.AreEqual(unum5000.UnumBits, bitMask5000);

            var bitMask6000 = new BitMask(new uint[] { 0x_1B_7747 }, 33);
            var unum6000 = new Unum(_environment_3_4, 6_000);
            Assert.AreEqual(unum6000.UnumBits, bitMask6000);
            ...
            var unumNegative1000 = new Unum(_environment_3_4, -1_000);
            var bitMaskNegative1000 = new BitMask(new uint[] { 0x_6_3D45, 1 }, 33);
        ...
        // {
        //    var first = new Unum(_environment_3_4, 30.0F);
        //    var second = new Unum(_environment_3_4, 9999999999999F);
