...
public class UnumEnvironmentTests
{
    ...
    public void UnumUncertaintyBitMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x20], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0x80, 0], _unum_3_4.Size),
    ...
    public void UnumExponentSizeMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x1C], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0x70, 0], _unum_3_4.Size),
    ...
    public void UnumFractionSizeMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0xF, 0], _unum_3_4.Size),
    ...
    public void UnumExponentAndFractionSizeMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x1F], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0x7F, 0], _unum_3_4.Size),
    ...
    public void UnumTagMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x3F], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFF, 0], _unum_3_4.Size),
    ...
    public void UnumSignBitMaskIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x40000], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0, 1], _unum_3_4.Size),
    ...
    public void UnumPositiveInfinityIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x3FFDF], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFF7F, 0], _unum_3_4.Size),
    ...
    public void UnumNegativeInfinityIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x7FFDF], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFF7F, 1], _unum_3_4.Size),
    ...
    public void UnumQuietNotANumberIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x3FFFF], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFFFF, 0], _unum_3_4.Size),
    ...
    public void UnumSignalingNotANumberIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x7FFFF], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFFFF, 1], _unum_3_4.Size),
    ...
    public void UnumLargestPositiveIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x3FF9F], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFE7F, 0], _unum_3_4.Size),
    ...
    public void UnumSmallestPositiveIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x5F], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0x17F, 0], _unum_3_4.Size),
    ...
    public void UnumLargestNegativeIsCorrect()
    {
        ...
        Assert.AreEqual(
            new BitMask([0x7FF9F], _unum_3_2.Size),
        ...
        Assert.AreEqual(
            new BitMask([0xFFFFFE7F, 1], _unum_3_4.Size),
