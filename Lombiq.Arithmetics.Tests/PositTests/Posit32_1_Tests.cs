	...
	public class Posit32_1Tests
	{
		...
		public void Posit32_1_IntConversionIsCorrect()
		{
			...
			Assert.AreEqual((int)new Posit32_1(1024), 1024);
						Assert.AreEqual((ulong)new Posit32_1((ulong)1.15292150460685E+18), (ulong)1152921504606846976);
		...
		public void Posit32_1_ConversionToOtherEnvsIsCorrect()
		{
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_0)new Posit32_1(0.01*i*i*i*1 )), new Posit8_0((double) new Posit32_1(0.01*i*i*i*1)), "Converting value " + (0.01*i*i*i*1) + "to Posit8_0 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_0 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_0)new Posit32_1(1.0-(1.0/(i+1))), new Posit8_0((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_0 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_1)new Posit32_1(0.01*i*i*i*2 )), new Posit8_1((double) new Posit32_1(0.01*i*i*i*2)), "Converting value " + (0.01*i*i*i*2) + "to Posit8_1 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_1 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_1)new Posit32_1(1.0-(1.0/(i+1))), new Posit8_1((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_1 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_2)new Posit32_1(0.01*i*i*i*3 )), new Posit8_2((double) new Posit32_1(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit8_2 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_2)new Posit32_1(1.0-(1.0/(i+1))), new Posit8_2((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_2 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_3)new Posit32_1(0.01*i*i*i*4 )), new Posit8_3((double) new Posit32_1(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit8_3 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_3)new Posit32_1(1.0-(1.0/(i+1))), new Posit8_3((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_3 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_4)new Posit32_1(0.01*i*i*i*5 )), new Posit8_4((double) new Posit32_1(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit8_4 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_4)new Posit32_1(1.0-(1.0/(i+1))), new Posit8_4((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_4 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_0)new Posit32_1(0.01*i*i*i*1 )), new Posit16_0((double) new Posit32_1(0.01*i*i*i*1)), "Converting value " + (0.01*i*i*i*1) + "to Posit16_0 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_0 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_0)new Posit32_1(1.0-(1.0/(i+1))), new Posit16_0((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_0 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_1)new Posit32_1(0.01*i*i*i*2 )), new Posit16_1((double) new Posit32_1(0.01*i*i*i*2)), "Converting value " + (0.01*i*i*i*2) + "to Posit16_1 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_1 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_1)new Posit32_1(1.0-(1.0/(i+1))), new Posit16_1((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_1 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_2)new Posit32_1(0.01*i*i*i*3 )), new Posit16_2((double) new Posit32_1(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit16_2 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_2)new Posit32_1(1.0-(1.0/(i+1))), new Posit16_2((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_2 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_3)new Posit32_1(0.01*i*i*i*4 )), new Posit16_3((double) new Posit32_1(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit16_3 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_3)new Posit32_1(1.0-(1.0/(i+1))), new Posit16_3((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_3 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_4)new Posit32_1(0.01*i*i*i*5 )), new Posit16_4((double) new Posit32_1(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit16_4 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_4)new Posit32_1(1.0-(1.0/(i+1))), new Posit16_4((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_4 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_0)new Posit32_1(0.01*i*i*i*1 )), new Posit32_0((double) new Posit32_1(0.01*i*i*i*1)), "Converting value " + (0.01*i*i*i*1) + "to Posit32_0 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_0 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_0)new Posit32_1(1.0-(1.0/(i+1))), new Posit32_0((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_0 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_2)new Posit32_1(0.01*i*i*i*3 )), new Posit32_2((double) new Posit32_1(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit32_2 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_2)new Posit32_1(1.0-(1.0/(i+1))), new Posit32_2((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_2 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_3)new Posit32_1(0.01*i*i*i*4 )), new Posit32_3((double) new Posit32_1(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit32_3 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_3)new Posit32_1(1.0-(1.0/(i+1))), new Posit32_3((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_3 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_4)new Posit32_1(0.01*i*i*i*5 )), new Posit32_4((double) new Posit32_1(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit32_4 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_4)new Posit32_1(1.0-(1.0/(i+1))), new Posit32_4((double) new Posit32_1( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_4 has failed. ");	
			}
			}
	}
}
