	...
	public class Posit8_0Tests
	{
		...
		public void Posit8_0_IntConversionIsCorrect()
		{
			...
			Assert.AreEqual((int)new Posit8_0(1024), 64);
						Assert.AreEqual((ulong)new Posit8_0((ulong)63), (ulong)64);
		...
		public void Posit8_0_AdditionIsCorrectForPositives()
		{
			...
			Assert.AreEqual(((uint)posit1), (uint)new Posit8_0(8));
		}
		...
		public void Posit8_0_AdditionIsCorrectForNegatives()
		{
			...
			Assert.AreEqual(((uint)posit1), (uint)new Posit8_0(3));
		}
		...
		public void Posit8_0_AdditionIsCorrectForReals()
		{
			...
			Assert.AreEqual(posit2, new Posit8_0(0.03125));
			Assert.AreEqual((posit1-posit2), new Posit8_0(-0.015625));
			Assert.AreEqual((new Posit8_0(1) - new Posit8_0(0.1)), new Posit8_0(0.9));
		...
		{
			 var posit1 = new Posit8_0(1);
			 Assert.AreEqual((posit1 * new Posit8_0(0.015625)), new Posit8_0(0.015625));
			 Assert.AreEqual((posit1 * new Posit8_0(256)), new Posit8_0(256));
			 Assert.AreEqual((-posit1 * new Posit8_0(3)), new Posit8_0(-3));
			 Assert.AreEqual((new Posit8_0(2) * new Posit8_0(0.015625)), new Posit8_0(0.03125));
			 Assert.AreEqual((new Posit8_0(4) * new Posit8_0(16)), new Posit8_0(64));
			 Assert.AreEqual((new Posit8_0(-3) * new Posit8_0(-4)), new Posit8_0(12));
		...
		{
			 var posit1 = new Posit8_0(1);
			 Assert.AreEqual((posit1 / new Posit8_0(0)), new Posit8_0(Posit8_0.NaNBitMask, true));
			 Assert.AreEqual((new Posit8_0(0.015625) / posit1), new Posit8_0(0.015625));
			 Assert.AreEqual((new Posit8_0(256) / posit1), new Posit8_0(256));
			 Assert.AreEqual((new Posit8_0(3) / -posit1), new Posit8_0(-3));
			 Assert.AreEqual((new Posit8_0(0.03125) / new Posit8_0(2)), new Posit8_0(0.015625));
			 Assert.AreEqual((new Posit8_0(64) / new Posit8_0(16)), new Posit8_0(4));
			 Assert.AreEqual((new Posit8_0(12) / new Posit8_0(-4)), new Posit8_0(-3));
		...
		{
			 var posit1 = new Posit8_0(1);
			 Assert.AreEqual(Posit8_0.Sqrt(posit1), posit1);
			 Assert.AreEqual(Posit8_0.Sqrt(-posit1), new Posit8_0(Posit8_0.NaNBitMask, true));
	 
			 Assert.AreEqual((Posit8_0.Sqrt(new Posit8_0(4))), new Posit8_0(2));
			 Assert.AreEqual((Posit8_0.Sqrt(new Posit8_0(64))), new Posit8_0(8));
			 Assert.AreEqual((Posit8_0.Sqrt(new Posit8_0(0.25))), new Posit8_0(0.5));
		...
		public void Posit8_0_ConversionToOtherEnvsIsCorrect()
		{
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_1)new Posit8_0(0.01*i*i*i*2 )), new Posit8_1((double) new Posit8_0(0.01*i*i*i*2)), "Converting value " + (0.01*i*i*i*2) + "to Posit8_1 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_1 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_1)new Posit8_0(1.0-(1.0/(i+1))), new Posit8_1((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_1 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_2)new Posit8_0(0.01*i*i*i*3 )), new Posit8_2((double) new Posit8_0(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit8_2 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_2)new Posit8_0(1.0-(1.0/(i+1))), new Posit8_2((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_2 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_3)new Posit8_0(0.01*i*i*i*4 )), new Posit8_3((double) new Posit8_0(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit8_3 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_3)new Posit8_0(1.0-(1.0/(i+1))), new Posit8_3((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_3 has failed. ");	
			}
			...
			for(var i = 0; i < 1600; i++){
				...
				Assert.AreEqual(((Posit8_4)new Posit8_0(0.01*i*i*i*5 )), new Posit8_4((double) new Posit8_0(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit8_4 has failed. ");	
			}

			for(var i = 0; i < 800; i++){
				//System.Console.WriteLine("Posit8_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit8_4)new Posit8_0(1.0-(1.0/(i+1))), new Posit8_4((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit8_4 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_0)new Posit8_0(0.01*i*i*i*1 )), new Posit16_0((double) new Posit8_0(0.01*i*i*i*1)), "Converting value " + (0.01*i*i*i*1) + "to Posit16_0 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_0 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_0)new Posit8_0(1.0-(1.0/(i+1))), new Posit16_0((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_0 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_1)new Posit8_0(0.01*i*i*i*2 )), new Posit16_1((double) new Posit8_0(0.01*i*i*i*2)), "Converting value " + (0.01*i*i*i*2) + "to Posit16_1 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_1 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_1)new Posit8_0(1.0-(1.0/(i+1))), new Posit16_1((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_1 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_2)new Posit8_0(0.01*i*i*i*3 )), new Posit16_2((double) new Posit8_0(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit16_2 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_2)new Posit8_0(1.0-(1.0/(i+1))), new Posit16_2((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_2 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_3)new Posit8_0(0.01*i*i*i*4 )), new Posit16_3((double) new Posit8_0(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit16_3 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_3)new Posit8_0(1.0-(1.0/(i+1))), new Posit16_3((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_3 has failed. ");	
			}
			...
			for(var i = 0; i < 3200; i++){
				...
				Assert.AreEqual(((Posit16_4)new Posit8_0(0.01*i*i*i*5 )), new Posit16_4((double) new Posit8_0(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit16_4 has failed. ");	
			}

			for(var i = 0; i < 1600; i++){
				//System.Console.WriteLine("Posit16_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit16_4)new Posit8_0(1.0-(1.0/(i+1))), new Posit16_4((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit16_4 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_0)new Posit8_0(0.01*i*i*i*1 )), new Posit32_0((double) new Posit8_0(0.01*i*i*i*1)), "Converting value " + (0.01*i*i*i*1) + "to Posit32_0 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_0 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_0)new Posit8_0(1.0-(1.0/(i+1))), new Posit32_0((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_0 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_1)new Posit8_0(0.01*i*i*i*2 )), new Posit32_1((double) new Posit8_0(0.01*i*i*i*2)), "Converting value " + (0.01*i*i*i*2) + "to Posit32_1 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_1 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_1)new Posit8_0(1.0-(1.0/(i+1))), new Posit32_1((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_1 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_2)new Posit8_0(0.01*i*i*i*3 )), new Posit32_2((double) new Posit8_0(0.01*i*i*i*3)), "Converting value " + (0.01*i*i*i*3) + "to Posit32_2 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_2 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_2)new Posit8_0(1.0-(1.0/(i+1))), new Posit32_2((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_2 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_3)new Posit8_0(0.01*i*i*i*4 )), new Posit32_3((double) new Posit8_0(0.01*i*i*i*4)), "Converting value " + (0.01*i*i*i*4) + "to Posit32_3 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_3 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_3)new Posit8_0(1.0-(1.0/(i+1))), new Posit32_3((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_3 has failed. ");	
			}
			...
			for(var i = 0; i < 6400; i++){
				...
				Assert.AreEqual(((Posit32_4)new Posit8_0(0.01*i*i*i*5 )), new Posit32_4((double) new Posit8_0(0.01*i*i*i*5)), "Converting value " + (0.01*i*i*i*5) + "to Posit32_4 has failed. ");	
			}

			for(var i = 0; i < 3200; i++){
				//System.Console.WriteLine("Posit32_4 : " + (1.0-(1.0/(i+1))) + " i: " + i );
				Assert.AreEqual((Posit32_4)new Posit8_0(1.0-(1.0/(i+1))), new Posit32_4((double) new Posit8_0( 1.0-(1.0/(i+1))) ), "Converting value " + (1.0-(1.0/(i+1))) + " to Posit32_4 has failed. ");	
			}
			}
	}
}
