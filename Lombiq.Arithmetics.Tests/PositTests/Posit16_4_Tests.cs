...
namespace Lombiq.Arithmetics.Tests
{
	...
	class Posit16_4Tests
	{
		...
		System.Console.WriteLine("Posit16_4 " +  Posit16_4.QuireSize + " fs: "+  Posit16_4.QuireFractionSize);
			var positArray = new Posit16_4[5];
			positArray[0] = new Posit16_4(0);
			for(var i=1;i<=4;i++) positArray[i] = new Posit16_4(0.5);          
			
			Assert.AreEqual(Posit16_4.FusedSum(positArray).PositBits, new Posit16_4(2).PositBits);
