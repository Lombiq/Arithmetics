...
namespace Lombiq.Arithmetics.Tests
{
	public class Posit16_4Tests
	{
		...
		public void Posit16_4_AdditionIsCorrectForPositives()
		{
			...
			Assert.AreEqual(((uint)posit1), (uint)new Posit16_4(512));
		}
		...
		public void Posit16_4_AdditionIsCorrectForNegatives()
		{
			...
			Assert.AreEqual(((uint)posit1), (uint)new Posit16_4(255));
		}
		...
		public void Posit16_4_AdditionIsCorrectForReals()
		{
			...
			Assert.AreEqual(posit2, new Posit16_4(0.03125));
			Assert.AreEqual((posit1-posit2), new Posit16_4(-0.015625));
			Assert.AreEqual((new Posit16_4(1) - new Posit16_4(0.1)), new Posit16_4(0.9));
			
			Assert.AreEqual((new Posit16_4(10.015625) - new Posit16_4(0.015625)), new Posit16_4(10));
			Assert.AreEqual((new Posit16_4(127.5) + new Posit16_4(127.5)), new Posit16_4(255));
			Assert.AreEqual((new Posit16_4(-16.625) + new Posit16_4(21.875)), new Posit16_4(-16.625 + 21.875));
		...
		{
			 var posit1 = new Posit16_4(1);
			 Assert.AreEqual((posit1 * new Posit16_4(0.015625)), new Posit16_4(0.015625));
			 Assert.AreEqual((posit1 * new Posit16_4(256)), new Posit16_4(256));
			 Assert.AreEqual((-posit1 * new Posit16_4(3)), new Posit16_4(-3));
			 Assert.AreEqual((new Posit16_4(2) * new Posit16_4(0.015625)), new Posit16_4(0.03125));
			 Assert.AreEqual((new Posit16_4(4) * new Posit16_4(16)), new Posit16_4(64));
			 Assert.AreEqual((new Posit16_4(-3) * new Posit16_4(-4)), new Posit16_4(12));
			
			 Assert.AreEqual((new Posit16_4(127.5) * new Posit16_4(2)), new Posit16_4(255));
			 Assert.AreEqual((new Posit16_4(-16.625) * new Posit16_4(-4)), new Posit16_4(66.5));		  					
		}	
		...
		{
			 var posit1 = new Posit16_4(1);
			 Assert.AreEqual((posit1 / new Posit16_4(0)), new Posit16_4(Posit16_4.NaNBitMask, true));
			 Assert.AreEqual((new Posit16_4(0.015625) / posit1), new Posit16_4(0.015625));
			 Assert.AreEqual((new Posit16_4(256) / posit1), new Posit16_4(256));
			 Assert.AreEqual((new Posit16_4(3) / -posit1), new Posit16_4(-3));
			 Assert.AreEqual((new Posit16_4(0.03125) / new Posit16_4(2)), new Posit16_4(0.015625));
			 Assert.AreEqual((new Posit16_4(64) / new Posit16_4(16)), new Posit16_4(4));
			 Assert.AreEqual((new Posit16_4(12) / new Posit16_4(-4)), new Posit16_4(-3));
			
			 Assert.AreEqual((new Posit16_4(252) / new Posit16_4(2)), new Posit16_4(126));
			 Assert.AreEqual((new Posit16_4(66.5) / new Posit16_4(-4)), new Posit16_4(-16.625));
		...
		{
			 var posit1 = new Posit16_4(1);
			 Assert.AreEqual(Posit16_4.Sqrt(posit1), posit1);
			 Assert.AreEqual(Posit16_4.Sqrt(-posit1), new Posit16_4(Posit16_4.NaNBitMask, true));
	 
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(4))), new Posit16_4(2));
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(64))), new Posit16_4(8));
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(0.25))), new Posit16_4(0.5));
			 
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(100))), new Posit16_4(10));
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(144))), new Posit16_4(12));
			 Assert.AreEqual((Posit16_4.Sqrt(new Posit16_4(896))), new Posit16_4(29.9332590942));
