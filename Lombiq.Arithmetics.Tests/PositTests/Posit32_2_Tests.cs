...
namespace Lombiq.Arithmetics.Tests
{
	...
	class Posit32_2Tests
	{
		...
		public void Posit32_2_MultiplicationIsCorrect()
		{
			var posit1 = new Posit32_2(1);
			 ...
			 (new Posit32_2(-3) * new Posit32_2(-4)).ShouldBe(new Posit32_2(12));
			   ...
			   (new Posit32_2(-16.625) * new Posit32_2(-4)).ShouldBe(new Posit32_2(66.5));
									   	(new Posit32_2(100) * new Posit32_2(0.9)).ShouldBe(new Posit32_2(90));
		...
		public void Posit32_2_DivisionIsCorrect()
		{
			 ...
			 (new Posit32_2(9500)  / new Posit32_2(-10000)).ShouldBe(new Posit32_2(-0.95));
			 (new Posit32_2(-80900) / new Posit32_2(100000)).ShouldBe(new Posit32_2(-0.809));
