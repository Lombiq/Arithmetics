...
namespace Lombiq.Arithmetics.Tests
{
    public class Posit16_3Tests
    {
        ...
        public void Posit16_3_AdditionIsCorrectForPositives()
        {
            ...
            Assert.AreEqual(((uint)posit1), (uint)new Posit16_3(512));
        }
        ...
        public void Posit16_3_AdditionIsCorrectForNegatives()
        {
            ...
            Assert.AreEqual(((uint)posit1), (uint)new Posit16_3(255));
        }
        ...
        public void Posit16_3_AdditionIsCorrectForReals()
        {
            ...
            Assert.AreEqual(posit2, new Posit16_3(0.03125));
            Assert.AreEqual((posit1-posit2), new Posit16_3(-0.015625));
            Assert.AreEqual((new Posit16_3(1) - new Posit16_3(0.1)), new Posit16_3(0.9));
            
            Assert.AreEqual((new Posit16_3(10.015625) - new Posit16_3(0.015625)), new Posit16_3(10));
            Assert.AreEqual((new Posit16_3(127.5) + new Posit16_3(127.5)), new Posit16_3(255));
            Assert.AreEqual((new Posit16_3(-16.625) + new Posit16_3(21.875)), new Posit16_3(-16.625 + 21.875));
        ...
        {
             var posit1 = new Posit16_3(1);
             Assert.AreEqual((posit1 * new Posit16_3(0.015625)), new Posit16_3(0.015625));
             Assert.AreEqual((posit1 * new Posit16_3(256)), new Posit16_3(256));
             Assert.AreEqual((-posit1 * new Posit16_3(3)), new Posit16_3(-3));
             Assert.AreEqual((new Posit16_3(2) * new Posit16_3(0.015625)), new Posit16_3(0.03125));
             Assert.AreEqual((new Posit16_3(4) * new Posit16_3(16)), new Posit16_3(64));
             Assert.AreEqual((new Posit16_3(-3) * new Posit16_3(-4)), new Posit16_3(12));
            
        	 Assert.AreEqual((new Posit16_3(127.5) * new Posit16_3(2)), new Posit16_3(255));
             Assert.AreEqual((new Posit16_3(-16.625) * new Posit16_3(-4)), new Posit16_3(66.5));          					
        }	
        ...
        {
             var posit1 = new Posit16_3(1);
             Assert.AreEqual((posit1 / new Posit16_3(0)), new Posit16_3(Posit16_3.NaNBitMask, true));
             Assert.AreEqual((new Posit16_3(0.015625) / posit1), new Posit16_3(0.015625));
             Assert.AreEqual((new Posit16_3(256) / posit1), new Posit16_3(256));
             Assert.AreEqual((new Posit16_3(3) / -posit1), new Posit16_3(-3));
             Assert.AreEqual((new Posit16_3(0.03125) / new Posit16_3(2)), new Posit16_3(0.015625));
             Assert.AreEqual((new Posit16_3(64) / new Posit16_3(16)), new Posit16_3(4));
             Assert.AreEqual((new Posit16_3(12) / new Posit16_3(-4)), new Posit16_3(-3));
            
             Assert.AreEqual((new Posit16_3(252) / new Posit16_3(2)), new Posit16_3(126));
             Assert.AreEqual((new Posit16_3(66.5) / new Posit16_3(-4)), new Posit16_3(-16.625));
        ...
        {
             var posit1 = new Posit16_3(1);
             Assert.AreEqual(Posit16_3.Sqrt(posit1), posit1);
             Assert.AreEqual(Posit16_3.Sqrt(-posit1), new Posit16_3(Posit16_3.NaNBitMask, true));
     
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(4))), new Posit16_3(2));
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(64))), new Posit16_3(8));
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(0.25))), new Posit16_3(0.5));
             
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(100))), new Posit16_3(10));
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(144))), new Posit16_3(12));
             Assert.AreEqual((Posit16_3.Sqrt(new Posit16_3(896))), new Posit16_3(29.9332590942));
