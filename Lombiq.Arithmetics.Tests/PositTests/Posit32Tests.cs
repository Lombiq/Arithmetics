...
namespace Lombiq.Arithmetics.Tests
{
    public class Posit32Tests
    {
        ...
        public void Posit32IsCorrectlyConstructedFromFloat()
        {
            ...
            Assert.AreEqual(new Posit32(100_000.5F).PositBits, 0b_01111100_01000011_01010000_01000000);
        ...
        public void Posit32IsCorrectlyConstructedFromDouble()
        {
            ...
            Assert.AreEqual(new Posit32(100_000.5).PositBits, 0b_01111100_01000011_01010000_01000000);
        ...
        public void Posit32ToFloatIsCorrect()
        {
            ...
            var posit5 = new Posit32(100_000.5F);
            Assert.AreEqual((float)posit5, 100_000.5);
        ...
        public void Posit32ToDoubleIsCorrect()
        {
            ...
            var posit5 = new Posit32(100_000.5);
            Assert.AreEqual((double)posit5, 100_000.5);
        ...
        public void Posit32ToQuireIsCorrect()
        {
            ...
            Assert.AreEqual(
                ...
                new Quire(
                    new ulong[]
                    {
                        0, 0, 0, 0x_FFFF_0000_0000_0000, ulong.MaxValue, ulong.MaxValue, ulong.MaxValue,
                        ulong.MaxValue,
                    },
                    512).Segments);
            ...
            Assert.AreEqual(
                ...
                new Quire(
                    new ulong[]
                    {
                        0, 0, 0, 0x_FFFD_0000_0000_0000, ulong.MaxValue, ulong.MaxValue, ulong.MaxValue,
                        ulong.MaxValue,
                    },
                    512).Segments);
